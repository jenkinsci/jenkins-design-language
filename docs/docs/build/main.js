webpackJsonp([0], {
            ...
            e.defineMode("javascript", function(t, n) {
                ...
                function tokenBase(e, t) {
                    ...
                    if ('"' == r || "'" == r) return t.tokenize = (n = r, function(e, t) {
                        var r, o = !1;
                        if (l && "@" == e.peek() && e.match(h)) return t.tokenize = tokenBase, ret("jsonld-keyword", "meta");
                        for (; null != (r = e.next()) && (r != n || o);) o = !o && "\\" == r;
                        return o || (t.tokenize = tokenBase), ret("string", "string")
                    }), t.tokenize(e, t);
                    if ("." == r && e.match(/^\d+(?:[eE][+\-]?\d+)?/)) return ret("number", "number");
                    if ("." == r && e.match("..")) return ret("spread", "meta");
                    if (/[\[\]{}\(\),;\:\.]/.test(r)) return ret(r);
                    if ("=" == r && e.eat(">")) return ret("=>", "operator");
                    if ("0" == r && e.match(/^(?:x[\da-f]+|o[0-7]+|b[01]+)n?/i)) return ret("number", "number");
                    if (/\d/.test(r)) return e.match(/^\d*(?:n|(?:\.\d*)?(?:[eE][+\-]?\d+)?)?/), ret("number", "number");
                    if ("/" == r) return e.eat("*") ? (t.tokenize = tokenComment, tokenComment(e, t)) : e.eat("/") ? (e.skipToEnd(), ret("comment", "comment")) : expressionAllowed(e, t, 1) ? (readRegexp(e), e.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), ret("regexp", "string-2")) : (e.eat("="), ret("operator", "operator", e.current()));
                    if ("`" == r) return t.tokenize = tokenQuasi, tokenQuasi(e, t);
                    if ("#" == r) return e.skipToEnd(), ret("error", "error");
                    if (u.test(r)) return ">" == r && t.lexical && ">" == t.lexical.type || (e.eat("=") ? "!" != r && "=" != r || e.eat("=") : /[<>*+\-]/.test(r) && (e.eat(r), ">" == r && e.eat(r))), ret("operator", "operator", e.current());
                    if (d.test(r)) {
                        e.eatWhile(d);
                        var o = e.current();
                        if ("." != t.lastType) {
                            ...
                            if ("async" == o && e.match(/^(\s|\/\*.*?\*\/)*[\[\(\w]/, !1)) return ret("async", "keyword", o)
                        }
                ...
                function parseJS(e, t, n, r, o) {
                    var i = e.cc;
                    for (g.state = e, g.stream = o, g.marked = null, g.cc = i, g.style = t, e.lexical.hasOwnProperty("align") || (e.lexical.align = !0);;) {
                        if ((i.length ? i.pop() : s ? expression : statement)(n, r)) {
                            for (; i.length && i[i.length - 1].lex;) i.pop()();
                            return g.marked ? g.marked : "variable" == n && inScope(e, r) ? "variable-2" : t
                        }
                    }
                }
                var g = {
                ...
                function register(e) {
                    var t = g.state;
                    if (g.marked = "def", t.context)
                        if ("var" == t.lexical.info && t.context && t.context.block) {
                            var r = registerVarScoped(e, t.context);
                            if (null != r) return void(t.context = r)
                        } else if (!inList(e, t.localVars)) return void(t.localVars = new Var(e, t.localVars));
                    n.globalVars && !inList(e, t.globalVars) && (t.globalVars = new Var(e, t.globalVars))
                }
                ...
                function pushcontext() {
                    g.state.context = new Context(g.state.context, g.state.localVars, !1), g.state.localVars = v
                }

                function pushblockcontext() {
                    g.state.context = new Context(g.state.context, g.state.localVars, !0), g.state.localVars = null
                }
                ...
                function pushlex(e, t) {
                    var n = function() {
                        ...
                        n.lexical = new JSLexical(r, g.stream.column(), e, null, n.lexical, t)
                    };
                    return n.lex = !0, n
                }
                ...
                function expressionInner(e, t, n) {
                    if (g.state.fatArrowAt == g.stream.start) {
                        ...
                        if ("(" == e) return cont(pushcontext, pushlex(")"), commasep(funarg, ")"), poplex, expect("=>"), r, popcontext);
                        if ("variable" == e) return pass(pushcontext, pattern, expect("=>"), r, popcontext)
                    }
                    var o = n ? maybeoperatorNoComma : maybeoperatorComma;
                    return m.hasOwnProperty(e) ? cont(o) : "function" == e ? cont(functiondef, o) : "class" == e || c && "interface" == t ? (g.marked = "keyword", cont(pushlex("form"), classExpression, poplex)) : "keyword c" == e || "async" == e ? cont(n ? expressionNoComma : expression) : "(" == e ? cont(pushlex(")"), maybeexpression, expect(")"), poplex, o) : "operator" == e || "spread" == e ? cont(n ? expressionNoComma : expression) : "[" == e ? cont(pushlex("]"), arrayLiteral, poplex, o) : "{" == e ? contCommasep(objprop, "}", null, o) : "quasi" == e ? pass(quasi, o) : "new" == e ? cont(maybeTarget(n)) : "import" == e ? cont(expression) : cont()
                }
                ...
                function continueQuasi(e) {
                    if ("}" == e) return g.marked = "string-2", g.state.tokenize = tokenQuasi, cont(quasi)
                }

                function arrowBody(e) {
                    return findFatArrow(g.stream, g.state), pass("{" == e ? statement : expression)
                }

                function arrowBodyNoComma(e) {
                    return findFatArrow(g.stream, g.state), pass("{" == e ? statement : expressionNoComma)
                }

                function maybeTarget(e) {
                    return function(t) {
                        return "." == t ? cont(e ? targetNoComma : target) : "variable" == t && c ? cont(maybeTypeArgs, e ? maybeoperatorNoComma : maybeoperatorComma) : pass(e ? expressionNoComma : expression)
                    }
                }

                function target(e, t) {
                    if ("target" == t) return g.marked = "keyword", cont(maybeoperatorComma)
                }

                function targetNoComma(e, t) {
                    if ("target" == t) return g.marked = "keyword", cont(maybeoperatorNoComma)
                }
                ...
                function property(e) {
                    if ("variable" == e) return g.marked = "property", cont()
                }

                function objprop(e, t) {
                    if ("async" == e) return g.marked = "property", cont(objprop);
                    if ("variable" == e || "keyword" == g.style) {
                        return g.marked = "property", "get" == t || "set" == t ? cont(getterSetter) : (c && g.state.fatArrowAt == g.stream.start && (n = g.stream.match(/^\s*:\s*/, !1)) && (g.state.fatArrowAt = g.stream.pos + n[0].length), cont(afterprop));
                        var n
                    } else {
                        if ("number" == e || "string" == e) return g.marked = l ? "property" : g.style + " property", cont(afterprop);
                        if ("jsonld-keyword" == e) return cont(afterprop);
                        if (c && isModifier(t)) return g.marked = "keyword", cont(objprop);
                        if ("[" == e) return cont(expression, maybetype, expect("]"), afterprop);
                        if ("spread" == e) return cont(expressionNoComma, afterprop);
                        if ("*" == t) return g.marked = "keyword", cont(objprop);
                        if (":" == e) return pass(afterprop)
                    }
                }

                function getterSetter(e) {
                    return "variable" != e ? pass(afterprop) : (g.marked = "property", cont(functiondef))
                }
                ...
                function commasep(e, t, n) {
                    function proceed(r, o) {
                        if (n ? n.indexOf(r) > -1 : "," == r) {
                            var i = g.state.lexical;
                            return "call" == i.info && (i.pos = (i.pos || 0) + 1), cont(function(n, r) {
                ...
                function mayberettype(e) {
                    if (c && ":" == e) return g.stream.match(/^\s*\w+\s+is\b/, !1) ? cont(expression, isKW, typeexpr) : cont(typeexpr)
                }

                function isKW(e, t) {
                    if ("is" == t) return g.marked = "keyword", cont()
                }

                function typeexpr(e, t) {
                    return "keyof" == t || "typeof" == t ? (g.marked = "keyword", cont("keyof" == t ? typeexpr : expressionNoComma)) : "variable" == e || "void" == t ? (g.marked = "type", cont(afterType)) : "string" == e || "number" == e || "atom" == e ? cont(afterType) : "[" == e ? cont(pushlex("]"), commasep(typeexpr, "]", ","), poplex, afterType) : "{" == e ? cont(pushlex("}"), commasep(typeprop, "}", ",;"), poplex, afterType) : "(" == e ? cont(commasep(typearg, ")"), maybeReturnType) : "<" == e ? cont(commasep(typeexpr, ">"), typeexpr) : void 0
                }
                ...
                function typeprop(e, t) {
                    return "variable" == e || "keyword" == g.style ? (g.marked = "property", cont(typeprop)) : "?" == t ? cont(typeprop) : ":" == e ? cont(typeexpr) : "[" == e ? cont(expression, maybetype, expect("]"), typeprop) : void 0
                }

                function typearg(e, t) {
                    return "variable" == e && g.stream.match(/^\s*[?:]/, !1) || "?" == t ? cont(typearg) : ":" == e ? cont(typeexpr) : pass(typeexpr)
                }

                function afterType(e, t) {
                    return "<" == t ? cont(pushlex(">"), commasep(typeexpr, ">"), poplex, afterType) : "|" == t || "." == e || "&" == t ? cont(typeexpr) : "[" == e ? cont(expect("]"), afterType) : "extends" == t || "implements" == t ? (g.marked = "keyword", cont(typeexpr)) : void 0
                }
                ...
                function vardef(e, t) {
                    return "enum" == t ? (g.marked = "keyword", cont(enumdef)) : pass(pattern, maybetype, maybeAssign, vardefCont)
                }

                function pattern(e, t) {
                    return c && isModifier(t) ? (g.marked = "keyword", cont(pattern)) : "variable" == e ? (register(t), cont()) : "spread" == e ? cont(pattern) : "[" == e ? contCommasep(pattern, "]") : "{" == e ? contCommasep(proppattern, "}") : void 0
                }

                function proppattern(e, t) {
                    return "variable" != e || g.stream.match(/^\s*:/, !1) ? ("variable" == e && (g.marked = "property"), "spread" == e ? cont(pattern) : "}" == e ? pass() : cont(expect(":"), pattern, maybeAssign)) : (register(t), cont(maybeAssign))
                }
                ...
                function forspec1(e) {
                    return "var" == e ? cont(vardef, expect(";"), forspec2) : ";" == e ? cont(forspec2) : "variable" == e ? cont(formaybeinof) : pass(expression, expect(";"), forspec2)
                }

                function formaybeinof(e, t) {
                    return "in" == t || "of" == t ? (g.marked = "keyword", cont(expression)) : cont(maybeoperatorComma, forspec2)
                }

                function forspec2(e, t) {
                    return ";" == e ? cont(forspec3) : "in" == t || "of" == t ? (g.marked = "keyword", cont(expression)) : pass(expression, expect(";"), forspec3)
                }
                ...
                function functiondef(e, t) {
                    return "*" == t ? (g.marked = "keyword", cont(functiondef)) : "variable" == e ? (register(t), cont(functiondef)) : "(" == e ? cont(pushcontext, pushlex(")"), commasep(funarg, ")"), poplex, mayberettype, statement, popcontext) : c && "<" == t ? cont(pushlex(">"), commasep(typeparam, ">"), poplex, functiondef) : void 0
                }

                function funarg(e, t) {
                    return "@" == t && cont(expression, funarg), "spread" == e ? cont(funarg) : c && isModifier(t) ? (g.marked = "keyword", cont(funarg)) : pass(pattern, maybetype, maybeAssign)
                }
                ...
                function classNameAfter(e, t) {
                    return "<" == t ? cont(pushlex(">"), commasep(typeparam, ">"), poplex, classNameAfter) : "extends" == t || "implements" == t || c && "," == e ? ("implements" == t && (g.marked = "keyword"), cont(c ? typeexpr : expression, classNameAfter)) : "{" == e ? cont(pushlex("}"), classBody, poplex) : void 0
                }

                function classBody(e, t) {
                    return "async" == e || "variable" == e && ("static" == t || "get" == t || "set" == t || c && isModifier(t)) && g.stream.match(/^\s+[\w$\xa1-\uffff]/, !1) ? (g.marked = "keyword", cont(classBody)) : "variable" == e || "keyword" == g.style ? (g.marked = "property", cont(c ? classfield : functiondef, classBody)) : "[" == e ? cont(expression, maybetype, expect("]"), c ? classfield : functiondef, classBody) : "*" == t ? (g.marked = "keyword", cont(classBody)) : ";" == e ? cont(classBody) : "}" == e ? cont() : "@" == t ? cont(expression, classBody) : void 0
                }

                function classfield(e, t) {
                    return "?" == t ? cont(classfield) : ":" == e ? cont(typeexpr, maybeAssign) : "=" == t ? cont(expressionNoComma) : pass(functiondef)
                }

                function afterExport(e, t) {
                    return "*" == t ? (g.marked = "keyword", cont(maybeFrom, expect(";"))) : "default" == t ? (g.marked = "keyword", cont(expression, expect(";"))) : "{" == e ? cont(commasep(exportField, "}"), maybeFrom, expect(";")) : pass(statement)
                }

                function exportField(e, t) {
                    return "as" == t ? (g.marked = "keyword", cont(expect("variable"))) : "variable" == e ? pass(expressionNoComma, exportField) : void 0
                }
                ...
                function importSpec(e, t) {
                    return "{" == e ? contCommasep(importSpec, "}") : ("variable" == e && register(t), "*" == t && (g.marked = "keyword"), cont(maybeAs))
                }
                ...
                function maybeAs(e, t) {
                    if ("as" == t) return g.marked = "keyword", cont(importSpec)
                }

                function maybeFrom(e, t) {
                    if ("from" == t) return g.marked = "keyword", cont(expression)
                }
                ...
                function expressionAllowed(e, t, n) {
                    return t.tokenize == tokenBase && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType) || "quasi" == t.lastType && /\{\s*$/.test(e.string.slice(0, e.pos - (n || 0)))
                }
                return popcontext.lex = !0, poplex.lex = !0, {
                    ...
                    token: function(e, t) {
                        if (e.sol() && (t.lexical.hasOwnProperty("align") || (t.lexical.align = !1), t.indented = e.indentation(), findFatArrow(e, t)), t.tokenize != tokenComment && e.eatSpace()) return null;
                        var n = t.tokenize(e, t);
                        return "comment" == r ? n : (t.lastType = "operator" != r || "++" != o && "--" != o ? r : "incdec", parseJS(t, n, r, o, e))
                    },
                    indent: function(t, r) {
                        if (t.tokenize == tokenComment) return e.Pass;
                        if (t.tokenize != tokenBase) return 0;
                        var o, l = r && r.charAt(0),
                            s = t.lexical;
                        if (!/^\s*else\b/.test(r))
                            for (var c = t.cc.length - 1; c >= 0; --c) {
                                var d = t.cc[c];
                                if (d == poplex) s = s.prev;
                                else if (d != maybeelse) break
                            }
                        for (;
                            ("stat" == s.type || "form" == s.type) && ("}" == l || (o = t.cc[t.cc.length - 1]) && (o == maybeoperatorComma || o == maybeoperatorNoComma) && !/^[,\.=+\-*:?[\(]/.test(r));) s = s.prev;
                        a && ")" == s.type && "stat" == s.prev.type && (s = s.prev);
                        var p = s.type,
                            u = l == p;
                        return "vardef" == p ? s.indented + ("operator" == t.lastType || "," == t.lastType ? s.info.length + 1 : 0) : "form" == p && "{" == l ? s.indented : "form" == p ? s.indented + i : "stat" == p ? s.indented + (isContinuedStatement(t, r) ? a || i : 0) : "switch" != s.info || u || 0 == n.doubleIndentSwitch ? s.align ? s.column + (u ? 0 : 1) : s.indented + (u ? 0 : i) : s.indented + (/^(?:case|default)\b/.test(r) ? i : 2 * i)
                    },
        ...
        var h = 10,
            f = function(e) {
                function Editor() {
                    ...
                    var e = _possibleConstructorReturn(this, (Editor.__proto__ || Object.getPrototypeOf(Editor)).call(this));
                    return e.handleChange = s()(e.handleChange.bind(e), h), e
                }
                return _inherits(Editor, r["Component"]), u(Editor, [{
                    key: "shouldComponentUpdate",
                    value: function shouldComponentUpdate(e) {
                        return !(!this.getEditorConfig(e).readOnly || e.code === this.props.code)
                    }
                }, {
                    key: "getEditorConfig",
    ...
    "8U58": function(e, t, n) {
        ...
        r = function() {
            ...
            var e = navigator.userAgent,
                ...
                i = /Edge\/(\d+)/.exec(e),
                a = r || o || i,
                l = a && (r ? document.documentMode || 6 : +(i || o)[1]),
                s = !i && /WebKit\//.test(e),
                c = s && /Qt\/\d+\.\d+/.test(e),
                d = !i && /Chrome\//.test(e),
                p = /Opera\//.test(e),
                ...
                f = /PhantomJS/.test(e),
                m = !i && /AppleWebKit/.test(e) && /Mobile\/\w+/.test(e),
                g = /Android/.test(e),
                v = m || g || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e),
                b = m || /Mac/.test(t),
                y = /\bCrOS\b/.test(e),
                x = /win/i.test(t),
                w = p && e.match(/Version\/(\d*\.\d*)/);
            w && (w = Number(w[1])), w && w >= 15 && (p = !1, s = !0);
            var C = b && (c || p && (null == w || w < 12.11)),
                k = n || a && l >= 9;
            ...
            function findColumn(e, t, n) {
                for (var r = 0, o = 0;;) {
                    var i = e.indexOf("\t", r); - 1 == i && (i = e.length);
                    var a = i - r;
            ...
            function createObj(e, t) {
                var n;
                return Object.create ? n = Object.create(e) : (nothing.prototype = e, n = new nothing), t && copyObj(t, n), n
            }
            ...
            function skipExtendingChars(e, t, n) {
                for (;
                    (n < 0 ? t > 0 : t < e.length) && isExtendingChar(e.charAt(t));) t += n;
                return t
            }
            ...
            function clipPos(e, t) {
                ...
                return t.line > n ? Pos(n, getLine(e, n).text.length) : clipToLen(t, getLine(e, t.line).text.length)
            }
            ...
            function markedSpansBefore(e, t, n) {
                ...
                if (e)
                    for (var o = 0; o < e.length; ++o) {
                        var i = e[o],
                            a = i.marker;
                        if (null == i.from || (a.inclusiveLeft ? i.from <= t : i.from < t) || i.from == t && "bookmark" == a.type && (!n || !i.marker.insertLeft)) {
            ...
            function markedSpansAfter(e, t, n) {
                ...
                if (e)
                    for (var o = 0; o < e.length; ++o) {
                        var i = e[o],
                            a = i.marker;
                        if (null == i.to || (a.inclusiveRight ? i.to >= t : i.to > t) || i.from == t && "bookmark" == a.type && (!n || i.marker.insertLeft)) {
                            var l = null == i.from || (a.inclusiveLeft ? i.from <= t : i.from < t);
                            (r || (r = [])).push(new MarkedSpan(a, l ? null : i.from - t, null == i.to ? null : i.to - t))
                        }
                    }
                return r
            }
            ...
            function stretchSpansOverChange(e, t) {
                ...
                var o = t.from.ch,
                    i = t.to.ch,
                    a = 0 == cmp(t.from, t.to),
                    l = markedSpansBefore(n, o, a),
                    s = markedSpansAfter(r, i, a),
                    c = 1 == t.text.length,
                    d = lst(t.text).length + (c ? o : 0);
                if (l)
                    for (var p = 0; p < l.length; ++p) {
                        var u = l[p];
                        if (null == u.to) {
                            var h = getMarkedSpanFor(s, u.marker);
                            h ? c && (u.to = null == h.to ? null : h.to + d) : u.to = o
                        }
                    }
                if (s)
                    for (var f = 0; f < s.length; ++f) {
                        var m = s[f];
                        if (null != m.to && (m.to += d), null == m.from) getMarkedSpanFor(l, m.marker) || (m.from = d, c && (l || (l = [])).push(m));
                        else m.from += d, c && (l || (l = [])).push(m)
                    }
                ...
                if (!c) {
                    ...
                    if (b > 0 && l)
                        for (var y = 0; y < l.length; ++y) null == l[y].to && (v || (v = [])).push(new MarkedSpan(l[y].marker, null, null));
            ...
            function removeReadOnlyRanges(e, t, n) {
                ...
                for (var o = [{
                    ...
                    for (var a = r[i], l = a.find(0), s = 0; s < o.length; ++s) {
                        var c = o[s];
                        if (!(cmp(c.to, l.from) < 0 || cmp(c.from, l.to) > 0)) {
                            var d = [s, 1],
                                p = cmp(c.from, l.from),
                                u = cmp(c.to, l.to);
                            (p < 0 || !a.inclusiveLeft && !p) && d.push({
                                from: c.from,
                                to: l.from
                            }), (u > 0 || !a.inclusiveRight && !u) && d.push({
                                from: l.to,
                                to: c.to
                            }), o.splice.apply(o, d), s += d.length - 3
                        }
                    }
                return o
            }
            ...
            function collapsedSpanAtSide(e, t) {
                var n, r = B && e.markedSpans;
                if (r)
                    for (var o = void 0, i = 0; i < r.length; ++i)(o = r[i]).marker.collapsed && null == (t ? o.from : o.to) && (!n || compareCollapsedMarkers(n, o.marker) < 0) && (n = o.marker);
                return n
            }
            ...
            function collapsedSpanAround(e, t) {
                ...
                if (r)
                    for (var o = 0; o < r.length; ++o) {
                        var i = r[o];
                        i.marker.collapsed && (null == i.from || i.from < t) && (null == i.to || i.to > t) && (!n || compareCollapsedMarkers(n, i.marker) < 0) && (n = i.marker)
                    }
                return n
            }
                    ...
                    for (var l = 0; l < a.length; ++l) {
                        ...
                        if (s.marker.collapsed) {
                            var c = s.marker.find(0),
                                d = cmp(c.from, n) || extraLeft(s.marker) - extraLeft(o),
                                p = cmp(c.to, r) || extraRight(s.marker) - extraRight(o);
                            if (!(d >= 0 && p <= 0 || d <= 0 && p >= 0) && (d <= 0 && (s.marker.inclusiveRight && o.inclusiveLeft ? cmp(c.to, n) >= 0 : cmp(c.to, n) > 0) || d >= 0 && (s.marker.inclusiveRight && o.inclusiveLeft ? cmp(c.from, r) <= 0 : cmp(c.from, r) < 0))) return !0
                        }
                    }
            }
            ...
            function lineIsHiddenInner(e, t, n) {
                ...
                for (var o = void 0, i = 0; i < t.markedSpans.length; ++i)
                    if ((o = t.markedSpans[i]).marker.collapsed && !o.marker.widgetNode && o.from == n.to && (null == o.to || o.to != n.from) && (o.marker.inclusiveLeft || n.marker.inclusiveRight) && lineIsHiddenInner(e, t, o)) return !0
            }
            ...
            function findMaxLine(e) {
                var t = e.display,
                    n = e.doc;
                t.maxLine = getLine(n, n.first), t.maxLineLength = lineLength(t.maxLine), t.maxLineChanged = !0, n.iter(function(e) {
                    var n = lineLength(e);
            ...
            function iterateBidiSections(e, t, n, r) {
                ...
                for (var o = !1, i = 0; i < e.length; ++i) {
                    var a = e[i];
                    (a.from < n && a.to > t || t == n && a.to == t) && (r(Math.max(a.from, t), Math.min(a.to, n), 1 == a.level ? "rtl" : "ltr", i), o = !0)
                }
                o || r(t, n, "ltr")
            }
            var F = null;
            ...
            function getBidiPartAt(e, t, n) {
                ...
                for (var o = 0; o < e.length; ++o) {
                    ...
                    i.to == t && (i.from != i.to && "before" == n ? r = o : F = o), i.from == t && (i.from != i.to && "before" != n ? r = o : F = o)
                }
                return null != r ? r : F
            }
            var z = function() {
                ...
                return function(l, s) {
                    var c = "ltr" == s ? "L" : "R";
                    if (0 == l.length || "ltr" == s && !n.test(l)) return !1;
                    for (var d, p = l.length, u = [], h = 0; h < p; ++h) u.push((d = l.charCodeAt(h)) <= 247 ? e.charAt(d) : 1424 <= d && d <= 1524 ? "R" : 1536 <= d && d <= 1785 ? t.charAt(d - 1536) : 1774 <= d && d <= 2220 ? "r" : 8192 <= d && d <= 8203 ? "w" : 8204 == d ? "b" : "L");
                    for (var f = 0, m = c; f < p; ++f) {
                        var g = u[f];
                        "m" == g ? u[f] = m : m = g
                    }
                    for (var v = 0, b = c; v < p; ++v) {
                        var y = u[v];
                        "1" == y && "r" == b ? u[v] = "n" : o.test(y) && (b = y, "r" == y && (u[v] = "R"))
                    }
                    for (var x = 1, w = u[0]; x < p - 1; ++x) {
                        var C = u[x];
                        "+" == C && "1" == w && "1" == u[x + 1] ? u[x] = "1" : "," != C || w != u[x + 1] || "1" != w && "n" != w || (u[x] = w), w = C
                    }
                    for (var k = 0; k < p; ++k) {
                        var S = u[k];
                        if ("," == S) u[k] = "N";
                            ...
                            var L = void 0;
                            for (L = k + 1; L < p && "%" == u[L]; ++L);
                            for (var M = k && "!" == u[k - 1] || L < p && "1" == u[L] ? "1" : "N", T = k; T < L; ++T) u[T] = M;
                            k = L - 1
                        }
                    }
                    for (var O = 0, P = c; O < p; ++O) {
                        var N = u[O];
                        "L" == P && "1" == N ? u[O] = "L" : o.test(N) && (P = N)
                    }
                    for (var A = 0; A < p; ++A)
                        if (r.test(u[A])) {
                            var D = void 0;
                            for (D = A + 1; D < p && r.test(u[D]); ++D);
                            for (var E = "L" == (A ? u[A - 1] : c), H = E == ("L" == (D < p ? u[D] : c)) ? E ? "L" : "R" : c, W = A; W < D; ++W) u[W] = H;
                            A = D - 1
                        }
                    for (var I, B = [], F = 0; F < p;)
                        if (i.test(u[F])) {
                            var z = F;
                            for (++F; F < p && i.test(u[F]); ++F);
                            B.push(new BidiSpan(0, z, F))
                        } else {
                            var R = F,
                                j = B.length;
                            for (++F; F < p && "L" != u[F]; ++F);
                            for (var V = R; V < F;)
                                if (a.test(u[V])) {
                                    R < V && B.splice(j, 0, new BidiSpan(1, R, V));
                                    var U = V;
                                    for (++V; V < F && a.test(u[V]); ++V);
                                    B.splice(j, 0, new BidiSpan(2, U, V)), R = V
                                } else ++V;
                            R < F && B.splice(j, 0, new BidiSpan(1, R, F))
                        }
                    return "ltr" == s && (1 == B[0].level && (I = l.match(/^\s+/)) && (B[0].from = I[0].length, B.unshift(new BidiSpan(0, 0, I[0].length))), 1 == lst(B).level && (I = l.match(/\s+$/)) && (lst(B).to -= I[0].length, B.push(new BidiSpan(0, p - I[0].length, p)))), "rtl" == s ? B.reverse() : B
                }
            }();
            ...
            function signalCursorActivity(e) {
                ...
                if (t)
                    for (var n = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), r = 0; r < t.length; ++r) - 1 == indexOf(n, t[r]) && n.push(t[r])
            }
            ...
            function zeroWidthElement(e) {
                if (null == V) {
                    var t = elt("span", "​");
                    removeChildrenAndAdd(e, elt("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (V = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(a && l < 8))
                }
            ...
            function hasBadBidiRects(e) {
                ...
                return removeChildren(e), !(!n || n.left == n.right) && (U = r.right - n.right < 3)
            }
            var G, K = 3 != "\n\nb".split(/\n/).length ? function(e) {
                    for (var t = 0, n = [], r = e.length; t <= r;) {
                        var o = e.indexOf("\n", t); - 1 == o && (o = e.length);
                        var i = e.slice(t, "\r" == e.charAt(o - 1) ? o - 1 : o),
                            a = i.indexOf("\r"); - 1 != a ? (n.push(i.slice(0, a)), t += a + 1) : (n.push(i), t = o + 1)
                    }
                    return n
                } : function(e) {
                    return e.split(/\r\n?|\n/)
                },
                q = window.getSelection ? function(e) {
                    try {
                ...
                $ = "oncopy" in (G = elt("div")) || (G.setAttribute("oncopy", "return;"), "function" == typeof G.oncopy),
                X = null;
            ...
            Q.prototype.eol = function() {
                ...
                if (o(this.string.substr(this.pos, e.length)) == o(e)) return !1 !== t && (this.pos += e.length), !0
            ...
            function highlightLine(e, t, n, r) {
                var o = [e.state.modeGen],
                    i = {};
                runMode(e, t.text, e.doc.mode, n, function(e, t) {
                    return o.push(e, t)
                }, i, r);
                for (var a = n.state, l = function(r) {
                        ...
                        var l = e.state.overlays[r],
                            s = 1,
                            c = 0;
                        n.state = !0, runMode(e, t.text, l.mode, n, function(e, t) {
                            for (var n = s; c < e;) {
                                var r = o[s];
                                r > e && o.splice(s, 1, e, o[s + 1], r), s += 2, c = Math.min(e, r)
                            }
                            if (t)
                                if (l.opaque) o.splice(n, s - n, e, "overlay " + t), s = n + 2;
                                else
                                    for (; n < s; n += 2) {
                                        var i = o[n + 1];
                                        o[n + 1] = (i ? i + " " : "") + "overlay " + t
            ...
            function getLineStyles(e, t, n) {
                if (!t.styles || t.styles[0] != e.state.modeGen) {
                    var r = getContextBefore(e, lineNo(t)),
                        o = t.text.length > e.options.maxHighlightLength && copyState(e.doc.mode, r.state),
                        i = highlightLine(e, t, r);
                    o && (r.state = o), t.stateAfter = r.save(!o), t.styles = i.styles, i.classes ? t.styleClasses = i.classes : t.styleClasses && (t.styleClasses = null), n === e.doc.highlightFrontier && (e.doc.modeFrontier = Math.max(e.doc.modeFrontier, ++e.doc.highlightFrontier))
                }
                return t.styles
            }
            ...
            function getContextBefore(e, t, n) {
                ...
                var i = findStartLine(e, t, n),
                    ...
                    l = a ? te.fromSaved(r, a, i) : new te(r, startState(r.mode), i);
                return r.iter(i, t, function(n) {
                    processLine(e, n.text, l);
                    var r = l.line;
                    n.stateAfter = r == t - 1 || r % 5 == 0 || r >= o.viewFrom && r < o.viewTo ? l.save() : null, l.nextLine()
            ...
            function processLine(e, t, n, r) {
                ...
                for (i.start = i.pos = r || 0, "" == t && callBlankLine(o, n.state); !i.eol();) readToken(o, i, n.state), i.start = i.pos
            }
            ...
            function takeToken(e, t, n, r) {
                var o, i, a = e.doc,
                    ...
                    d = new Q(s.text, e.options.tabSize, c);
                for (r && (i = []);
                    (r || d.pos < t.ch) && !d.eol();) d.start = d.pos, o = readToken(l, d, c.state), r && i.push(new ne(d, o, copyState(a.mode, c.state)));
                return r ? i : new ne(d, o, c.state)
            }
            ...
            function runMode(e, t, n, r, o, i, a) {
                ...
                var s, c = 0,
                    d = null,
                    p = new Q(t, e.options.tabSize, r),
                    u = e.options.addModeClass && [null];
                for ("" == t && extractLineClasses(callBlankLine(n, r.state), i); !p.eol();) {
                    if (p.pos > e.options.maxHighlightLength ? (l = !1, a && processLine(e, t, r, p.pos), p.pos = t.length, s = null) : s = extractLineClasses(readToken(n, p, r.state, u), i), u) {
                        var h = u[0].name;
                        h && (s = "m-" + (s ? h + " " + s : h))
                    }
                    if (!l || d != s) {
                        for (; c < p.start;) o(c = Math.min(p.start, c + 5e3), d);
                        d = s
                    }
                    p.start = p.pos
                }
            ...
            function findStartLine(e, t, n) {
                for (var r, o, i = e.doc, a = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), l = t; l > a; --l) {
                    if (l <= i.first) return i.first;
                    var s = getLine(i, l - 1),
                        c = s.stateAfter;
                    if (c && (!n || l + (c instanceof ee ? c.lookAhead : 0) <= i.modeFrontier)) return l;
                    var d = countColumn(s.text, null, e.options.tabSize);
                    (null == o || r > d) && (o = l - 1, r = d)
                }
                return o
            }
            ...
            function buildLineContent(e, t) {
                ...
                for (var o = 0; o <= (t.rest ? t.rest.length : 0); o++) {
                    var i = o ? t.rest[o - 1] : t.line,
                        l = void 0;
                    r.pos = 0, r.addToken = buildToken, hasBadBidiRects(e.display.measure) && (l = getOrder(i, e.doc.direction)) && (r.addToken = buildTokenBadBidi(r.addToken, l)), r.map = [], insertLineContent(i, r, getLineStyles(e, i, t != e.display.externalMeasured && lineNo(i))), i.styleClasses && (i.styleClasses.bgClass && (r.bgClass = joinClasses(i.styleClasses.bgClass, r.bgClass || "")), i.styleClasses.textClass && (r.textClass = joinClasses(i.styleClasses.textClass, r.textClass || ""))), 0 == r.map.length && r.map.push(0, 0, r.content.appendChild(zeroWidthElement(e.display.measure))), 0 == o ? (t.measure.map = r.map, t.measure.cache = {}) : ((t.measure.maps || (t.measure.maps = [])).push(r.map), (t.measure.caches || (t.measure.caches = [])).push({}))
                }
                if (s) {
                ...
                return signal(e, "renderLine", e, t.line, r.pre), r.pre.className && (r.textClass = joinClasses(r.pre.className, r.textClass || "")), r
            }
            ...
            function buildToken(e, t, n, r, o, i, s) {
                if (t) {
                    var c, d = e.splitSpaces ? splitSpaces(t, e.trailingSpace) : t,
                    ...
                    if (p.test(t)) {
                        ...
                        for (var h = 0;;) {
                            ...
                            if (m) {
                                ...
                                a && l < 9 ? c.appendChild(elt("span", [g])) : c.appendChild(g), e.map.push(e.pos, e.pos + m, g), e.col += m, e.pos += m
                            }
                            if (!f) break;
                            h += m + 1;
                            var v = void 0;
                            if ("\t" == f[0]) {
                                var b = e.cm.options.tabSize,
                                    y = b - e.col % b;
                                (v = c.appendChild(elt("span", spaceStr(y), "cm-tab"))).setAttribute("role", "presentation"), v.setAttribute("cm-text", "\t"), e.col += y
                            } else "\r" == f[0] || "\n" == f[0] ? ((v = c.appendChild(elt("span", "\r" == f[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", f[0]), e.col += 1) : ((v = e.cm.options.specialCharPlaceholder(f[0])).setAttribute("cm-text", f[0]), a && l < 9 ? c.appendChild(elt("span", [v])) : c.appendChild(v), e.col += 1);
                            e.map.push(e.pos, e.pos + 1, v), e.pos++
                        }
                    } else e.col += t.length, c = document.createTextNode(d), e.map.push(e.pos, e.pos + t.length, c), a && l < 9 && (u = !0), e.pos += t.length;
                    if (e.trailingSpace = 32 == d.charCodeAt(t.length - 1), n || r || o || u || s) {
                        var x = n || "";
                        r && (x += r), o && (x += o);
                        var w = elt("span", [c], x, s);
                        return i && (w.title = i), e.content.appendChild(w)
                    }
            ...
            function buildTokenBadBidi(e, t) {
                return function(n, r, o, i, a, l, s) {
                    o = o ? o + " cm-force-border" : "cm-force-border";
                    for (var c = n.pos, d = c + r.length;;) {
                        for (var p = void 0, u = 0; u < t.length && !((p = t[u]).to > c && p.from <= c); u++);
                        if (p.to >= d) return e(n, r, o, i, a, l, s);
                        e(n, r.slice(0, p.to - c), o, i, null, l, s), i = null, r = r.slice(p.to - c), c = p.to
                    }
                }
            }
            ...
            function insertLineContent(e, t, n) {
                var r = e.markedSpans,
                    ...
                    i = 0;
                if (r)
                    for (var a, l, s, c, d, p, u, h = o.length, f = 0, m = 1, g = "", v = 0;;) {
                        if (v == f) {
                            s = c = d = p = l = "", u = null, v = 1 / 0;
                            for (var b = [], y = void 0, x = 0; x < r.length; ++x) {
                                var w = r[x],
                                    C = w.marker;
                                "bookmark" == C.type && w.from == f && C.widgetNode ? b.push(C) : w.from <= f && (null == w.to || w.to > f || C.collapsed && w.to == f && w.from == f) ? (null != w.to && w.to != f && v > w.to && (v = w.to, c = ""), C.className && (s += " " + C.className), C.css && (l = (l ? l + ";" : "") + C.css), C.startStyle && w.from == f && (d += " " + C.startStyle), C.endStyle && w.to == v && (y || (y = [])).push(C.endStyle, w.to), C.title && !p && (p = C.title), C.collapsed && (!u || compareCollapsedMarkers(u.marker, C) < 0) && (u = w)) : w.from > f && v > w.from && (v = w.from)
                            }
                            if (y)
                                for (var k = 0; k < y.length; k += 2) y[k + 1] == v && (c += " " + y[k]);
                            if (!u || u.from == f)
                                for (var S = 0; S < b.length; ++S) buildCollapsedSpan(t, 0, b[S]);
                            if (u && (u.from || 0) == f) {
                                if (buildCollapsedSpan(t, (null == u.to ? h + 1 : u.to) - f, u.marker, null == u.from), null == u.to) return;
                                u.to == f && (u = !1)
                            }
                        }
                        if (f >= h) break;
                        for (var L = Math.min(h, v);;) {
                            if (g) {
                                var M = f + g.length;
                                if (!u) {
                                    var T = M > L ? g.slice(0, L - f) : g;
                                    t.addToken(t, T, a ? a + s : s, d, f + T.length == v ? c : "", p, l)
                                }
                                if (M >= L) {
                                    g = g.slice(L - f), f = L;
                                    break
                            ...
                            g = o.slice(i, i = n[m++]), a = interpretTokenStyle(n[m++], t.cm.options)
                        }
                    } else
                        for (var O = 1; O < n.length; O += 2) t.addToken(t, o.slice(i, i = n[O]), interpretTokenStyle(n[O + 1], t.cm.options))
            }
            ...
            function signalLater(e, t) {
                ...
                if (n.length) {
                    ...
                    ae ? r = ae.delayedCallbacks : le ? r = le : (r = le = [], setTimeout(fireOrphanDelayed, 0));
            ...
            function updateLineForChanges(e, t, n, r) {
                for (var o = 0; o < t.changes.length; o++) {
                    var i = t.changes[o];
                    "text" == i ? updateLineText(e, t) : "gutter" == i ? updateLineGutter(e, t, n, r) : "class" == i ? updateLineClasses(e, t) : "widget" == i && updateLineWidgets(e, t, r)
                }
                t.changes = null
            }

            function ensureLineWrapped(e) {
                return e.node == e.text && (e.node = elt("div", null, null, "position: relative"), e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text), e.node.appendChild(e.text), a && l < 8 && (e.node.style.zIndex = 2)), e.node
            }
            ...
            function updateLineBackground(e, t) {
                ...
                if (n && (n += " CodeMirror-linebackground"), t.background) n ? t.background.className = n : (t.background.parentNode.removeChild(t.background), t.background = null);
                    ...
                    t.background = r.insertBefore(elt("div", null, n), r.firstChild), e.display.input.setUneditable(t.background)
                }
            }
            ...
            function updateLineText(e, t) {
                ...
                t.text == t.node && (t.node = r.pre), t.text.parentNode.replaceChild(r.pre, t.text), t.text = r.pre, r.bgClass != t.bgClass || r.textClass != t.textClass ? (t.bgClass = r.bgClass, t.textClass = r.textClass, updateLineClasses(e, t)) : n && (t.text.className = n)
            }

            function updateLineClasses(e, t) {
                updateLineBackground(e, t), t.line.wrapClass ? ensureLineWrapped(t).className = t.line.wrapClass : t.node != t.text && (t.node.className = "");
            ...
            function updateLineGutter(e, t, n, r) {
                if (t.gutter && (t.node.removeChild(t.gutter), t.gutter = null), t.gutterBackground && (t.node.removeChild(t.gutterBackground), t.gutterBackground = null), t.line.gutterClass) {
                    ...
                    t.gutterBackground = elt("div", null, "CodeMirror-gutter-background " + t.line.gutterClass, "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px; width: " + r.gutterTotalWidth + "px"), e.display.input.setUneditable(t.gutterBackground), o.insertBefore(t.gutterBackground, t.text)
                }
                var i = t.line.gutterMarkers;
                if (e.options.lineNumbers || i) {
                    var a = ensureLineWrapped(t),
                        l = t.gutter = elt("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px");
                    if (e.display.input.setUneditable(l), a.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(elt("div", lineNumberFor(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), i)
                        for (var s = 0; s < e.options.gutters.length; ++s) {
                            var c = e.options.gutters[s],
                                d = i.hasOwnProperty(c) && i[c];
                            d && l.appendChild(elt("div", [d], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[c] + "px; width: " + r.gutterWidth[c] + "px"))
                        }
                }
            }
            ...
            function buildLineElement(e, t, n, r) {
                ...
                return t.text = t.node = o.pre, o.bgClass && (t.bgClass = o.bgClass), o.textClass && (t.textClass = o.textClass), updateLineClasses(e, t), updateLineGutter(e, t, n, r), insertLineWidgets(e, t, r), t.node
            }
            ...
            function insertLineWidgetsFor(e, t, n, r, o) {
                if (t.widgets)
                    for (var i = ensureLineWrapped(n), a = 0, l = t.widgets; a < l.length; ++a) {
                        var s = l[a],
                            c = elt("div", [s.node], "CodeMirror-linewidget");
                        s.handleMouseEvents || c.setAttribute("cm-ignore-events", "true"), positionLineWidget(s, c, n, r), e.display.input.setUneditable(c), o && s.above ? i.insertBefore(c, n.gutter || n.text) : i.appendChild(c), signalLater(s, "redraw")
                    }
            }
                ...
                if (!t.measure.heights || r && t.measure.width != o) {
                    ...
                    if (r) {
                        ...
                        for (var a = t.text.firstChild.getClientRects(), l = 0; l < a.length - 1; l++) {
                            var s = a[l],
                                c = a[l + 1];
                            Math.abs(s.bottom - c.bottom) > 2 && i.push((s.bottom + c.top) / 2 - n.top)
                        }
                    }
            ...
            function prepareMeasureForLine(e, t) {
                ...
                r && !r.text ? r = null : r && r.changes && (updateLineForChanges(e, r, n, getDimensions(e)), e.curOp.forceUpdate = !0), r || (r = updateExternalMeasurement(e, t));
            ...
            function measureCharPrepared(e, t, n, r, o) {
                t.before && (n = -1);
                var i, a = n + (r || "");
                return t.cache.hasOwnProperty(a) ? i = t.cache[a] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()), t.hasHeights || (ensureLineHeights(e, t.view, t.rect), t.hasHeights = !0), (i = measureCharInner(e, t, n, r)).bogus || (t.cache[a] = i)), {
                    left: i.left,
                    right: i.right,
                    top: o ? i.rtop : i.top,
            ...
            function nodeAndOffsetInLineMap(e, t, n) {
                for (var r, o, i, a, l, s, c = 0; c < e.length; c += 3)
                    if (l = e[c], s = e[c + 1], t < l ? (o = 0, i = 1, a = "left") : t < s ? i = (o = t - l) + 1 : (c == e.length - 3 || t == s && e[c + 3] > t) && (o = (i = s - l) - 1, t >= s && (a = "right")), null != o) {
                        if (r = e[c + 2], l == s && n == (r.insertLeft ? "left" : "right") && (a = n), "left" == n && 0 == o)
            ...
            function measureCharInner(e, t, n, r) {
                var o, i = nodeAndOffsetInLineMap(t.map, n, r),
                    s = i.node,
                    c = i.start,
                    d = i.end,
                    p = i.collapse;
                if (3 == s.nodeType) {
                    for (var u = 0; u < 4; u++) {
                        ...
                        for (; i.coverStart + d < i.coverEnd && isExtendingChar(t.line.text.charAt(i.coverStart + d));) ++d;
                        if ((o = a && l < 9 && 0 == c && d == i.coverEnd - i.coverStart ? s.parentNode.getBoundingClientRect() : getUsefulRect(S(s, c, d).getClientRects(), r)).left || o.right || 0 == c) break;
                        d = c, c -= 1, p = "right"
                    }
                    a && l < 11 && (o = maybeUpdateRectForZooming(e.display.measure, o))
                } else {
                    var h;
                    c > 0 && (p = r = "right"), o = e.options.lineWrapping && (h = s.getClientRects()).length > 1 ? h["right" == r ? h.length - 1 : 0] : s.getBoundingClientRect()
                }
                if (a && l < 9 && !c && (!o || !o.left && !o.right)) {
                ...
                for (var m = o.top - t.rect.top, g = o.bottom - t.rect.top, v = (m + g) / 2, b = t.view.measure.heights, y = 0; y < b.length - 1 && !(v < b[y]); y++);
                var x = y ? b[y - 1] : 0,
                    w = b[y],
                    C = {
                        left: ("right" == p ? o.right : o.left) - t.rect.left,
                        right: ("left" == p ? o.left : o.right) - t.rect.left,
                        top: x,
                        bottom: w
                    };
                return o.left || o.right || (C.bogus = !0), e.options.singleCursorHeightPerLine || (C.rtop = m, C.rbottom = g), C
            }

            function maybeUpdateRectForZooming(e, t) {
                if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !hasBadZoomedRects(e)) return t;
            ...
            function intoCoordSystem(e, t, n, r, o) {
                ...
                if ("local" == r ? a += paddingTop(e.display) : a -= e.display.viewOffset, "page" == r || "window" == r) {
                    ...
                    a += l.top + ("window" == r ? 0 : pageScrollY());
                    var s = l.left + ("window" == r ? 0 : pageScrollX());
                    n.left += s, n.right += s
                }
            ...
            function charCoords(e, t, n, r, o) {
                return r || (r = getLine(e.doc, t.line)), intoCoordSystem(e, r, measureChar(e, r, t.ch, o), n)
            }

            function cursorCoords(e, t, n, r, o, i) {
                function get(t, a) {
                    var l = measureCharPrepared(e, o, t, a ? "right" : "left", i);
                    return a ? l.left = l.right : l.right = l.left, intoCoordSystem(e, r, l, n)
                }
                r = r || getLine(e.doc, t.line), o || (o = prepareMeasureForLine(e, r));
                var a = getOrder(r, e.doc.direction),
                    l = t.ch,
                    s = t.sticky;
                if (l >= r.text.length ? (l = r.text.length, s = "before") : l <= 0 && (l = 0, s = "after"), !a) return get("before" == s ? l - 1 : l, "before" == s);
                ...
                var c = getBidiPartAt(a, l, s),
                    d = F,
                    p = getBidi(l, c, "before" == s);
                return null != d && (p.other = getBidi(l, d, "before" != s)), p
            }
            ...
            function coordsChar(e, t, n) {
                ...
                var o = lineAtHeight(r, n),
                    i = r.first + r.size - 1;
                if (o > i) return PosWithInfo(r.first + r.size - 1, getLine(r, i).text.length, null, !0, 1);
                t < 0 && (t = 0);
                for (var a = getLine(r, o);;) {
                    var l = coordsCharInner(e, a, o, t, n),
                        s = collapsedSpanAround(a, l.ch + (l.xRel > 0 ? 1 : 0));
                    if (!s) return l;
                    var c = s.find(1);
            ...
            function wrappedLineExtent(e, t, n, r) {
                r -= widgetTopHeight(t);
                var o = t.text.length,
                    i = findFirst(function(t) {
                        return measureCharPrepared(e, n, t - 1).bottom <= r
                    }, o, 0);
                return {
                    begin: i,
                    end: o = findFirst(function(t) {
            ...
            function wrappedLineExtentChar(e, t, n, r) {
                return n || (n = prepareMeasureForLine(e, t)), wrappedLineExtent(e, t, n, intoCoordSystem(e, t, measureCharPrepared(e, n, r), "line").top)
            }
            ...
            function coordsCharInner(e, t, n, r, o) {
                ...
                var i = prepareMeasureForLine(e, t),
                    ...
                    s = t.text.length,
                    c = !0,
                    d = getOrder(t, e.doc.direction);
                if (d) {
                    var p = (e.options.lineWrapping ? coordsBidiPartWrapped : coordsBidiPart)(e, t, n, i, d, r, o);
                    l = (c = 1 != p.level) ? p.from : p.to - 1, s = c ? p.to : p.from - 1
                }
                var u, h, f = null,
                    m = null,
                    g = findFirst(function(t) {
                        var n = measureCharPrepared(e, i, t);
                        return n.top += a, n.bottom += a, !!boxIsAfter(n, r, o, !1) && (n.top <= o && n.left <= r && (f = t, m = n), !0)
                    }, l, s),
                    v = !1;
                if (m) {
                    ...
                    c || g != s && g != l || g++, h = 0 == g ? "after" : g == t.text.length ? "before" : measureCharPrepared(e, i, g - (c ? 1 : 0)).bottom + a <= o == c ? "after" : "before";
                    var x = cursorCoords(e, Pos(n, g, h), "line", t, i);
                    u = x.left, v = o < x.top || o >= x.bottom
                }
                return PosWithInfo(n, g = skipExtendingChars(t.text, g, 1), h, v, r - u)
            }

            function coordsBidiPart(e, t, n, r, o, i, a) {
                var l = findFirst(function(l) {
                        var s = o[l],
                            c = 1 != s.level;
                        return boxIsAfter(cursorCoords(e, Pos(n, c ? s.to : s.from, c ? "before" : "after"), "line", t, r), i, a, !0)
                    }, 0, o.length - 1),
                    s = o[l];
                if (l > 0) {
                    var c = 1 != s.level,
                        d = cursorCoords(e, Pos(n, c ? s.from : s.to, c ? "after" : "before"), "line", t, r);
                    boxIsAfter(d, i, a, !0) && d.top > a && (s = o[l - 1])
                }
                return s
            }

            function coordsBidiPartWrapped(e, t, n, r, o, i, a) {
                var l = wrappedLineExtent(e, t, r, a),
                    s = l.begin,
                    c = l.end;
                /\s/.test(t.text.charAt(c - 1)) && c--;
                for (var d = null, p = null, u = 0; u < o.length; u++) {
                    var h = o[u];
                    if (!(h.from >= c || h.to <= s)) {
                        var f = measureCharPrepared(e, r, 1 != h.level ? Math.min(c, h.to) - 1 : Math.max(s, h.from)).right,
                            m = f < i ? i - f + 1e9 : f - i;
                        (!d || p > m) && (d = h, p = m)
                    }
                }
                return d || (d = o[o.length - 1]), d.from < s && (d = {
                    from: s,
                    to: d.to,
                    level: d.level
                }), d.to > c && (d = {
            ...
            function textHeight(e) {
                ...
                if (null == se) {
                    se = elt("pre");
                    for (var t = 0; t < 49; ++t) se.appendChild(document.createTextNode("x")), se.appendChild(elt("br"));
                    se.appendChild(document.createTextNode("x"))
                }
                removeChildrenAndAdd(e.measure, se);
                var n = se.offsetHeight / 50;
            ...
            function posFromMouse(e, t, n, r) {
                ...
                var i, a, l = o.lineSpace.getBoundingClientRect();
                try {
                    i = t.clientX - l.left, a = t.clientY - l.top
                } catch (t) {
                    return null
                }
                var s, c = coordsChar(e, i, a);
                if (r && 1 == c.xRel && (s = getLine(e.doc, c.line).text).length == c.ch) {
                    var d = countColumn(s, s.length, e.options.tabSize) - s.length;
                    c = Pos(c.line, Math.max(0, Math.round((i - paddingH(e.display).left) / charWidth(e.display)) - d))
                }
                return c
            }
                ...
                for (var n = e.doc, r = {}, o = r.cursors = document.createDocumentFragment(), i = r.selection = document.createDocumentFragment(), a = 0; a < n.sel.ranges.length; a++)
                    if (t || a != n.sel.primIndex) {
                        ...
                        if (!(l.from().line >= e.display.viewTo || l.to().line < e.display.viewFrom)) {
                            var s = l.empty();
                            (s || e.options.showCursorWhenSelecting) && drawSelectionCursor(e, l.head, o), s || drawSelectionRange(e, l, i)
                        }
                    }
                return r
            }
            ...
            function drawSelectionCursor(e, t, n) {
                ...
                if (o.style.left = r.left + "px", o.style.top = r.top + "px", o.style.height = Math.max(0, r.bottom - r.top) * e.options.cursorHeight + "px", r.other) {
                    var i = n.appendChild(elt("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor"));
            ...
            function drawSelectionRange(e, t, n) {
                var r = e.display,
                    ...
                    l = a.left,
                    s = Math.max(r.sizerWidth, displayWidth(e) - r.sizer.offsetLeft) - a.right,
                    c = "ltr" == o.direction;

                function add(e, t, n, r) {
                    t < 0 && (t = 0), t = Math.round(t), r = Math.round(r), i.appendChild(elt("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px;\n                             top: " + t + "px; width: " + (null == n ? s - e : n) + "px;\n                             height: " + (r - t) + "px"))
                }

                function drawForLine(t, n, r) {
                    var i, a, d = getLine(o, t),
                        p = d.text.length;

                    function coords(n, r) {
                        return charCoords(e, Pos(t, n), "div", d, r)
                    }

                    function wrapX(t, n, r) {
                        var o = wrappedLineExtentChar(e, d, null, t),
                            i = "ltr" == n == ("after" == r) ? "left" : "right";
                        return coords("after" == r ? o.begin : o.end - (/\s/.test(d.text.charAt(o.end - 1)) ? 2 : 1), i)[i]
                    }
                    var u = getOrder(d, o.direction);
                    return iterateBidiSections(u, n || 0, null == r ? p : r, function(e, t, o, d) {
                        var h = "ltr" == o,
                            f = coords(e, h ? "left" : "right"),
                            m = coords(t - 1, h ? "right" : "left"),
                            g = null == n && 0 == e,
                            v = null == r && t == p,
                            b = 0 == d,
                            y = !u || d == u.length - 1;
                        if (m.top - f.top <= 3) {
                            var x = (c ? v : g) && y,
                                w = (c ? g : v) && b ? l : (h ? f : m).left,
                                C = x ? s : (h ? m : f).right;
                            add(w, f.top, C - w, f.bottom)
                        } else {
                            var k, S, L, M;
                            h ? (k = c && g && b ? l : f.left, S = c ? s : wrapX(e, o, "before"), L = c ? l : wrapX(t, o, "after"), M = c && v && y ? s : m.right) : (k = c ? wrapX(e, o, "before") : l, S = !c && g && b ? s : f.right, L = !c && v && y ? l : m.left, M = c ? wrapX(t, o, "after") : s), add(k, f.top, S - k, f.bottom), f.bottom < m.top && add(l, f.bottom, null, m.top), add(L, m.top, M - L, m.bottom)
                        }(!i || cmpCoords(f, i) < 0) && (i = f), cmpCoords(m, i) < 0 && (i = m), (!a || cmpCoords(f, a) < 0) && (a = f), cmpCoords(m, a) < 0 && (a = m)
                    }), {
                        start: i,
                        end: a
                    }
                ...
                var d = t.from(),
                    p = t.to();
                if (d.line == p.line) drawForLine(d.line, d.ch, p.ch);
                else {
                    var u = getLine(o, d.line),
                        h = getLine(o, p.line),
                        f = visualLine(u) == visualLine(h),
                        m = drawForLine(d.line, d.ch, f ? u.text.length + 1 : null).end,
                        g = drawForLine(p.line, f ? 0 : null, p.ch).start;
                    f && (m.top < g.top - 2 ? (add(m.right, m.top, null, m.bottom), add(l, g.top, g.left, g.bottom)) : add(m.right, m.top, g.left - m.right, m.bottom)), m.bottom < g.top && add(l, m.bottom, null, g.top)
                }
                n.appendChild(i)
            }
            ...
            function onFocus(e, t) {
                e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1), "nocursor" != e.options.readOnly && (e.state.focused || (signal(e, "focus", e, t), e.state.focused = !0, addClass(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), s && setTimeout(function() {
            ...
            function updateHeightsInViewport(e) {
                for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                    ...
                    if (!o.hidden) {
                        ...
                        var d = o.line.height - i;
                        if (i < 2 && (i = textHeight(t)), (d > .005 || d < -.005) && (updateLineHeight(o.line, i), updateWidgetHeight(o.line), o.rest))
                            for (var p = 0; p < o.rest.length; p++) updateWidgetHeight(o.rest[p])
                    }
                }
            }
            ...
            function visibleLines(e, t, n) {
                ...
                if (n && n.ensure) {
                    var l = n.ensure.from.line,
                        s = n.ensure.to.line;
                    l < i ? (i = l, a = lineAtHeight(t, heightAtLine(getLine(t, l)) + e.wrapper.clientHeight)) : Math.min(s, t.lastLine()) >= a && (i = lineAtHeight(t, heightAtLine(getLine(t, s)) - e.wrapper.clientHeight), a = s)
                }
                return {
                    from: i,
                    to: Math.max(a, i + 1)
            ...
            function alignHorizontally(e) {
                ...
                if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
                    for (var r = compensateForHScroll(t) - t.scroller.scrollLeft + e.doc.scrollLeft, o = t.gutters.offsetWidth, i = r + "px", a = 0; a < n.length; a++)
                        if (!n[a].hidden) {
                            e.options.fixedGutter && (n[a].gutter && (n[a].gutter.style.left = i), n[a].gutterBackground && (n[a].gutterBackground.style.left = i));
                            var l = n[a].alignable;
                            if (l)
                                for (var s = 0; s < l.length; s++) l[s].style.left = i
                        }
            ...
            function maybeUpdateLineNumberWidth(e) {
                ...
                if (n.length != r.lineNumChars) {
                    var o = r.measure.appendChild(elt("div", [elt("div", n)], "CodeMirror-linenumber CodeMirror-gutter-elt")),
                        i = o.firstChild.offsetWidth,
                        a = o.offsetWidth - i;
                    return r.lineGutter.style.width = "", r.lineNumInnerWidth = Math.max(i, r.lineGutter.offsetWidth - a) + 1, r.lineNumWidth = r.lineNumInnerWidth + a, r.lineNumChars = r.lineNumInnerWidth ? n.length : -1, r.lineGutter.style.width = r.lineNumWidth + "px", updateGutterSpace(e), !0
                }
                return !1
            }
            ...
            function maybeScrollWindow(e, t) {
                if (!signalDOMEvent(e, "scrollCursorIntoView")) {
                    var n = e.display,
                        ...
                        o = null;
                    if (t.top + r.top < 0 ? o = !0 : t.bottom + r.top > (window.innerHeight || document.documentElement.clientHeight) && (o = !1), null != o && !f) {
                        var i = elt("div", "​", null, "position: absolute;\n                         top: " + (t.top - n.viewOffset - paddingTop(e.display)) + "px;\n                         height: " + (t.bottom - t.top + scrollGap(e) + n.barHeight) + "px;\n                         left: " + t.left + "px; width: " + Math.max(2, t.right - t.left) + "px;");
            ...
            function scrollPosIntoView(e, t, n, r) {
                var o;
                null == r && (r = 0), e.options.lineWrapping || t != n || (n = "before" == (t = t.ch ? Pos(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after") : t).sticky ? Pos(t.line, t.ch + 1, "before") : t);
                for (var i = 0; i < 5; i++) {
                    var a = !1,
                        l = cursorCoords(e, t),
                        s = n && n != t ? cursorCoords(e, n) : l,
                        c = calculateScrollPos(e, o = {
                        ...
                        d = e.doc.scrollTop,
                        p = e.doc.scrollLeft;
                    if (null != c.scrollTop && (updateScrollTop(e, c.scrollTop), Math.abs(e.doc.scrollTop - d) > 1 && (a = !0)), null != c.scrollLeft && (setScrollLeft(e, c.scrollLeft), Math.abs(e.doc.scrollLeft - p) > 1 && (a = !0)), !a) break
                }
                return o
            }
            ...
            function calculateScrollPos(e, t) {
                ...
                var l = e.doc.height + paddingVert(n),
                    s = t.top < r,
                    c = t.bottom > l - r;
                if (t.top < o) a.scrollTop = s ? 0 : t.top;
                else if (t.bottom > o + i) {
                    var d = Math.min(t.top, (c ? l : t.bottom) - i);
                    d != o && (a.scrollTop = d)
                }
                var p = e.curOp && null != e.curOp.scrollLeft ? e.curOp.scrollLeft : n.scroller.scrollLeft,
                    u = displayWidth(e) - (e.options.fixedGutter ? n.gutters.offsetWidth : 0),
                    h = t.right - t.left > u;
                return h && (t.right = t.left + u), t.left < 10 ? a.scrollLeft = 0 : t.left < p ? a.scrollLeft = Math.max(0, t.left - (h ? 0 : 10)) : t.right > u + p - 3 && (a.scrollLeft = t.right + (h ? 0 : 10) - u), a
            }
            ...
            function resolveScrollToPos(e) {
                ...
                t && (e.curOp.scrollToPos = null, scrollToCoordsRange(e, estimateCoords(e, t.from), estimateCoords(e, t.to), t.margin))
            }
            ...
            function updateScrollTop(e, t) {
                Math.abs(e.doc.scrollTop - t) < 2 || (n || updateDisplaySimple(e, {
                    top: t
                }), setScrollTop(e, t, !0), n && updateDisplaySimple(e), startWorker(e, 100))
            }
            ...
            function setScrollLeft(e, t, n, r) {
                t = Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth), (n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r || (e.doc.scrollLeft = t, alignHorizontally(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t))
            }
            ...
            var de = function(e, t, n) {
                ...
                var r = this.vert = elt("div", [elt("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar"),
                    o = this.horiz = elt("div", [elt("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar");
                r.tabIndex = o.tabIndex = -1, e(r), e(o), j(r, "scroll", function() {
            ...
            de.prototype.update = function(e) {
                ...
                var e = b && !h ? "12px" : "18px";
                this.horiz.style.height = this.vert.style.width = e, this.horiz.style.pointerEvents = this.vert.style.pointerEvents = "none", this.disableHoriz = new T, this.disableVert = new T
            }, de.prototype.enableZeroWidthBar = function(e, t, n) {
                e.style.pointerEvents = "auto", t.set(1e3, function maybeDisable() {
                    var r = e.getBoundingClientRect();
                    ("vert" == n ? document.elementFromPoint(r.right - 1, (r.top + r.bottom) / 2) : document.elementFromPoint((r.right + r.left) / 2, r.bottom - 1)) != e ? e.style.pointerEvents = "none" : t.set(1e3, maybeDisable)
                })
            ...
            function updateScrollbars(e, t) {
                ...
                for (var o = 0; o < 4 && n != e.display.barWidth || r != e.display.barHeight; o++) n != e.display.barWidth && e.options.lineWrapping && updateHeightsInViewport(e), updateScrollbarsInner(e, measureForScrollbars(e)), n = e.display.barWidth, r = e.display.barHeight
            }
            ...
            }, pe.prototype.setScrollLeft = function() {}, pe.prototype.setScrollTop = function() {}, pe.prototype.clear = function() {};
            var ue = {
                native: de,
                null: pe
            };
            ...
            function initScrollbars(e) {
                e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && L(e.display.wrapper, e.display.scrollbars.addClass)), e.display.scrollbars = new ue[e.options.scrollbarStyle](function(t) {
                    e.display.wrapper.insertBefore(t, e.display.scrollbarFiller), j(t, "mousedown", function() {
                ...
                }, e), e.display.scrollbars.addClass && addClass(e.display.wrapper, e.display.scrollbars.addClass)
            }
            var he = 0;
            ...
            function startOperation(e) {
                ...
                e.curOp = {
                    ...
                    focus: !1,
                    id: ++he
                }, t = e.curOp, ae ? ae.ops.push(t) : t.ownsGroup = ae = {
                    ops: [t],
                    delayedCallbacks: []
                }
            }
            ...
            function endOperations(e) {
                ...
                for (var o = 0; o < n.length; o++)(t = n[o]).updatedDisplay = t.mustUpdate && updateDisplayIfNeeded(t.cm, t.update);
                for (var i = 0; i < n.length; i++) endOperation_R2(n[i]);
                for (var a = 0; a < n.length; a++) endOperation_W2(n[a]);
                for (var l = 0; l < n.length; l++) endOperation_finish(n[l])
            }

            function endOperation_R1(e) {
                var t = e.cm,
                    n = t.display;
                maybeClipScrollbars(t), e.updateMaxLine && findMaxLine(t), e.mustUpdate = e.viewChanged || e.forceUpdate || null != e.scrollTop || e.scrollToPos && (e.scrollToPos.from.line < n.viewFrom || e.scrollToPos.to.line >= n.viewTo) || n.maxLineChanged && t.options.lineWrapping, e.update = e.mustUpdate && new fe(t, e.mustUpdate && {
                    top: e.scrollTop,
            ...
            function endOperation_R2(e) {
                var t = e.cm,
                    n = t.display;
                e.updatedDisplay && updateHeightsInViewport(t), e.barMeasure = measureForScrollbars(t), n.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = measureChar(t, n.maxLine, n.maxLine.text.length).left + 3, t.display.sizerWidth = e.adjustWidthTo, e.barMeasure.scrollWidth = Math.max(n.scroller.clientWidth, n.sizer.offsetLeft + e.adjustWidthTo + scrollGap(t) + t.display.barWidth), e.maxScrollLeft = Math.max(0, n.sizer.offsetLeft + e.adjustWidthTo - displayWidth(t))), (e.updatedDisplay || e.selectionChanged) && (e.preparedSelection = n.input.prepareSelection())
            }
            ...
            function regChange(e, t, n, r) {
                ...
                var o = e.display;
                if (r && n < o.viewTo && (null == o.updateLineNumbers || o.updateLineNumbers > t) && (o.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= o.viewTo) B && visualLineNo(e.doc, t) < o.viewTo && resetView(e);
                else if (n <= o.viewFrom) B && visualLineEndNo(e.doc, n + r) > o.viewFrom ? resetView(e) : (o.viewFrom += r, o.viewTo += r);
                else if (t <= o.viewFrom && n >= o.viewTo) resetView(e);
                else if (t <= o.viewFrom) {
                    var i = viewCuttingPoint(e, n, n + r, 1);
                    i ? (o.view = o.view.slice(i.index), o.viewFrom = i.lineN, o.viewTo += r) : resetView(e)
                } else if (n >= o.viewTo) {
                    var a = viewCuttingPoint(e, t, t, -1);
                    a ? (o.view = o.view.slice(0, a.index), o.viewTo = a.lineN) : resetView(e)
                } else {
                    var l = viewCuttingPoint(e, t, t, -1),
                        s = viewCuttingPoint(e, n, n + r, 1);
                    l && s ? (o.view = o.view.slice(0, l.index).concat(buildViewArray(e, l.lineN, s.lineN)).concat(o.view.slice(s.index)), o.viewTo += r) : resetView(e)
                }
            ...
            function regLineChange(e, t, n) {
                ...
                if (o && t >= o.lineN && t < o.lineN + o.size && (r.externalMeasured = null), !(t < r.viewFrom || t >= r.viewTo)) {
                    ...
                    if (null != i.node) {
                        var a = i.changes || (i.changes = []); - 1 == indexOf(a, n) && a.push(n)
                    }
                }
            }
            ...
            function viewCuttingPoint(e, t, n, r) {
                var o, i = findViewIndex(e, t),
                    a = e.display.view;
                if (!B || n == e.doc.first + e.doc.size) return {
                    index: i,
                    lineN: n
                };
            ...
            function adjustView(e, t, n) {
                var r = e.display;
                0 == r.view.length || t >= r.viewTo || n <= r.viewFrom ? (r.view = buildViewArray(e, t, n), r.viewFrom = t) : (r.viewFrom > t ? r.view = buildViewArray(e, t, r.viewFrom).concat(r.view) : r.viewFrom < t && (r.view = r.view.slice(findViewIndex(e, t))), r.viewFrom = t, r.viewTo < n ? r.view = r.view.concat(buildViewArray(e, r.viewTo, n)) : r.viewTo > n && (r.view = r.view.slice(0, findViewIndex(e, n)))), r.viewTo = n
            }
                ...
                if (!(t.highlightFrontier >= e.display.viewTo)) {
                    ...
                    t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function(i) {
                        if (r.line >= e.display.viewFrom) {
                            var a = i.styles,
                                l = i.text.length > e.options.maxHighlightLength ? copyState(t.mode, r.state) : null,
                                s = highlightLine(e, i, r, !0);
                            l && (r.state = l), i.styles = s.styles;
                            var c = i.styleClasses,
                                d = s.classes;
                            d ? i.styleClasses = d : c && (i.styleClasses = null);
                            for (var p = !a || a.length != i.styles.length || c != d && (!c || !d || c.bgClass != d.bgClass || c.textClass != d.textClass), u = 0; !p && u < a.length; ++u) p = a[u] != i.styles[u];
                            p && o.push(r.line), i.stateAfter = r.save(), r.nextLine()
                        } else i.text.length <= e.options.maxHighlightLength && processLine(e, i.text, r), i.stateAfter = r.line % 5 == 0 ? r.save() : null, r.nextLine();
                        if (+new Date > n) return startWorker(e, e.options.workDelay), !0
                    }), t.highlightFrontier = r.line, t.modeFrontier = Math.max(t.modeFrontier, r.line), o.length && runInOp(e, function() {
            ...
            var fe = function(e, t, n) {
                var r = e.display;
                this.viewport = t, this.visible = visibleLines(r, e.doc, t), this.editorIsHidden = !r.wrapper.offsetWidth, this.wrapperHeight = r.wrapper.clientHeight, this.wrapperWidth = r.wrapper.clientWidth, this.oldDisplayWidth = displayWidth(e), this.force = n, this.dims = getDimensions(e), this.events = []
            };

            function maybeClipScrollbars(e) {
                var t = e.display;
                !t.scrollbarsClipped && t.scroller.offsetWidth && (t.nativeBarWidth = t.scroller.offsetWidth - t.scroller.clientWidth, t.heightForcer.style.height = scrollGap(e) + "px", t.sizer.style.marginBottom = -t.nativeBarWidth + "px", t.sizer.style.borderRightWidth = scrollGap(e) + "px", t.scrollbarsClipped = !0)
            }
            ...
            function selectionSnapshot(e) {
                ...
                if (window.getSelection) {
                    ...
                    r.anchorNode && r.extend && contains(e.display.lineDiv, r.anchorNode) && (n.anchorNode = r.anchorNode, n.anchorOffset = r.anchorOffset, n.focusNode = r.focusNode, n.focusOffset = r.focusOffset)
                }
                return n
            }
            ...
            function updateDisplayIfNeeded(e, t) {
                ...
                n.viewFrom < i && i - n.viewFrom < 20 && (i = Math.max(r.first, n.viewFrom)), n.viewTo > a && n.viewTo - a < 20 && (a = Math.min(o, n.viewTo)), B && (i = visualLineNo(e.doc, i), a = visualLineEndNo(e.doc, a));
                var l = i != n.viewFrom || a != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth;
                adjustView(e, i, a), n.viewOffset = heightAtLine(getLine(e.doc, n.viewFrom)), e.display.mover.style.top = n.viewOffset + "px";
                ...
                return s > 4 && (n.lineDiv.style.display = "none"), patchDisplay(e, n.updateLineNumbers, t.dims), s > 4 && (n.lineDiv.style.display = ""), n.renderedView = n.view, restoreSelection(c), removeChildren(n.cursorDiv), removeChildren(n.selectionDiv), n.gutters.style.height = n.sizer.style.minHeight = 0, l && (n.lastWrapHeight = t.wrapperHeight, n.lastWrapWidth = t.wrapperWidth, startWorker(e, 400)), n.updateLineNumbers = null, !0
            }

            function postUpdateDisplay(e, t) {
                for (var n = t.viewport, r = !0;
                    (r && e.options.lineWrapping && t.oldDisplayWidth != displayWidth(e) || (n && null != n.top && (n = {
                        top: Math.min(e.doc.height + paddingVert(e.display) - displayHeight(e), n.top)
                    }), t.visible = visibleLines(e.display, e.doc, n), !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && updateDisplayIfNeeded(e, t); r = !1) {
                    updateHeightsInViewport(e);
                    var o = measureForScrollbars(e);
                    updateSelection(e), updateScrollbars(e, o), setDocumentHeight(e, o), t.force = !1
                }
            ...
            function patchDisplay(e, t, n) {
                ...
                function rm(t) {
                    var n = t.nextSibling;
                    return s && b && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t), n
                }
                for (var l = r.view, c = r.viewFrom, d = 0; d < l.length; d++) {
                    var p = l[d];
                    if (p.hidden);
                    else if (p.node && p.node.parentNode == i) {
                        for (; a != p.node;) a = rm(a);
                        var u = o && null != t && t <= c && p.lineNumber;
                        p.changes && (indexOf(p.changes, "gutter") > -1 && (u = !1), updateLineForChanges(e, p, c, n)), u && (removeChildren(p.lineNumber), p.lineNumber.appendChild(document.createTextNode(lineNumberFor(e.options, c)))), a = p.node.nextSibling
                    } else {
                        var h = buildLineElement(e, p, c, n);
                        i.insertBefore(h, a)
                    }
                    c += p.size
                }
            ...
            function setGuttersForLineNumbers(e) {
                var t = indexOf(e.gutters, "CodeMirror-linenumbers"); - 1 == t && e.lineNumbers ? e.gutters = e.gutters.concat(["CodeMirror-linenumbers"]) : t > -1 && !e.lineNumbers && (e.gutters = e.gutters.slice(0), e.gutters.splice(t, 1))
            }
            ...
            function onScrollWheel(e, t) {
                ...
                if (o && c || i && d) {
                    if (i && b && s) e: for (var u = t.target, h = a.view; u != l; u = u.parentNode)
                        for (var f = 0; f < h.length; f++)
                            if (h[f].node == u) {
                                e.display.currentWheelTarget = u;
                                break e
                            }
                    if (o && !n && !p && null != ge) return i && d && updateScrollTop(e, Math.max(0, l.scrollTop + i * ge)), setScrollLeft(e, Math.max(0, l.scrollLeft + o * ge)), (!i || i && d) && e_preventDefault(t), void(a.wheelStartX = null);
                    if (i && null != ge) {
                        var m = i * ge,
                            g = e.doc.scrollTop,
                            v = g + a.wrapper.clientHeight;
                        m < 0 ? g = Math.max(0, g + m - 50) : v = Math.min(e.doc.height, v + m + 50), updateDisplaySimple(e, {
                            top: g,
                            bottom: v
                        })
                    }
                    me < 20 && (null == a.wheelStartX ? (a.wheelStartX = l.scrollLeft, a.wheelStartY = l.scrollTop, a.wheelDX = o, a.wheelDY = i, setTimeout(function() {
                        if (null != a.wheelStartX) {
                            ...
                            a.wheelStartX = a.wheelStartY = null, n && (ge = (ge * me + n) / (me + 1), ++me)
                        }
                    }, 200)) : (a.wheelDX += o, a.wheelDY += i))
                }
            }
            a ? ge = -.53 : n ? ge = 15 : d ? ge = -.7 : u && (ge = -1 / 3);
            var ve = function(e, t) {
            ...
            ve.prototype.primary = function() {
                ...
                for (var e = [], t = 0; t < this.ranges.length; t++) e[t] = new be(copyPos(this.ranges[t].anchor), copyPos(this.ranges[t].head));
                ...
                for (var r = 1; r < e.length; r++) {
                    ...
                    if (cmp(i.to(), o.from()) >= 0) {
                        var a = minPos(i.from(), o.from()),
                            l = maxPos(i.to(), o.to()),
                            s = i.empty() ? o.from() == o.head : i.from() == i.head;
                        r <= t && --t, e.splice(--r, 2, new be(s ? l : a, s ? a : l))
                    }
                }
                return new ve(e, t)
            }
            ...
            function computeSelAfterChange(e, t) {
                for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
                    ...
                    n.push(new be(adjustForChange(o.anchor, t), adjustForChange(o.head, t)))
                }
            ...
            function computeReplacedSel(e, t, n) {
                for (var r = [], o = Pos(e.first, 0), i = o, a = 0; a < t.length; a++) {
                    var l = t[a],
                        s = offsetPos(l.from, o, i),
                        c = offsetPos(changeEnd(l), o, i);
                    if (o = l.to, i = c, "around" == n) {
                        var d = e.sel.ranges[a],
                            p = cmp(d.head, d.anchor) < 0;
                        r[a] = new be(p ? c : s, p ? s : c)
                    } else r[a] = new be(s, s)
                }
            ...
            function updateDoc(e, t, n, r) {
                ...
                var o = t.from,
                    ...
                    s = getLine(e, i.line),
                    c = lst(a),
                    d = spansFor(a.length - 1),
                    p = i.line - o.line;
                if (t.full) e.insert(0, linesFor(0, a.length)), e.remove(a.length, e.size - a.length);
                else if (isWholeLineUpdate(e, t)) {
                    var u = linesFor(0, a.length - 1);
                    update(s, s.text, d), p && e.remove(o.line, p), u.length && e.insert(o.line, u)
                } else if (l == s)
                    if (1 == a.length) update(l, l.text.slice(0, o.ch) + c + l.text.slice(i.ch), d);
                    else {
                        var h = linesFor(1, a.length - 1);
                        h.push(new re(c + l.text.slice(i.ch), d, r)), update(l, l.text.slice(0, o.ch) + a[0], spansFor(0)), e.insert(o.line + 1, h)
                    }
                else if (1 == a.length) update(l, l.text.slice(0, o.ch) + a[0] + s.text.slice(i.ch), spansFor(0)), e.remove(o.line + 1, p);
                else {
                    update(l, l.text.slice(0, o.ch) + a[0], spansFor(0)), update(s, c + s.text.slice(i.ch), d);
                    var f = linesFor(1, a.length - 1);
                    p > 1 && e.remove(o.line + 1, p - 1), e.insert(o.line + 1, f)
                }
            ...
            function lastChangeEvent(e, t) {
                return t ? (clearSelectionEvents(e.done), lst(e.done)) : e.done.length && !lst(e.done).ranges ? lst(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(), lst(e.done)) : void 0
            }
            ...
            function addChangeToHistory(e, t, n, r) {
                ...
                o.undone.length = 0;
                var i, a, l = +new Date;
                if ((o.lastOp == r || o.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && o.lastModTime > l - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (i = lastChangeEvent(o, o.lastOp == r))) a = lst(i.changes), 0 == cmp(t.from, t.to) && 0 == cmp(t.from, a.to) ? a.to = changeEnd(t) : i.changes.push(historyChangeFromChange(e, t));
                else {
                    var s = lst(o.done);
                    for (s && s.ranges || pushSelectionToHistory(e.sel, o.done), i = {
                            changes: [historyChangeFromChange(e, t)],
                            generation: o.generation
                        }, o.done.push(i); o.done.length > o.undoDepth;) o.done.shift(), o.done[0].ranges || o.done.shift()
                }
                o.done.push(n), o.generation = ++o.maxGeneration, o.lastModTime = o.lastSelTime = l, o.lastOp = o.lastSelOp = r, o.lastOrigin = o.lastSelOrigin = t.origin, a || signal(e, "historyAdded")
            }
            ...
            function addSelectionToHistory(e, t, n, r) {
                var o = e.history,
                    i = r && r.origin;
                n == o.lastSelOp || i && o.lastSelOrigin == i && (o.lastModTime == o.lastSelTime && o.lastOrigin == i || selectionEventCanBeMerged(e, i, lst(o.done), t)) ? o.done[o.done.length - 1] = t : pushSelectionToHistory(t, o.done), o.lastSelTime = +new Date, o.lastSelOrigin = i, o.lastSelOp = n, r && !1 !== r.clearRedo && clearSelectionEvents(o.undone)
            }
            ...
            function getOldSpans(e, t) {
                var n = t["spans_" + e.id];
                if (!n) return null;
                for (var r = [], o = 0; o < t.text.length; ++o) r.push(removeClearedSpans(n[o]));
                return r
            }
            ...
            function mergeOldSpans(e, t) {
                ...
                for (var o = 0; o < n.length; ++o) {
                    var i = n[o],
                        a = r[o];
                    if (i && a) e: for (var l = 0; l < a.length; ++l) {
                        for (var s = a[l], c = 0; c < i.length; ++c)
                            if (i[c].marker == s.marker) continue e;
                        i.push(s)
                    } else a && (n[o] = a)
                }
                return n
                    ...
                    if (i.ranges) r.push(n ? ve.prototype.deepCopy.call(i) : i);
                        ...
                        for (var s = 0; s < a.length; ++s) {
                            ...
                            if (l.push({
                                ...
                                for (var p in c)(d = p.match(/^spans_(\d+)$/)) && indexOf(t, Number(d[1])) > -1 && (lst(l)[p] = c[p], delete c[p])
                        }
                    }
                }
                return r
            ...
            function extendSelection(e, t, n, r, o) {
                null == o && (o = e.cm && (e.cm.display.shift || e.extend)), setSelection(e, new ve([extendRange(e.sel.primary(), t, n, o)], 0), r)
            }

            function extendSelections(e, t, n) {
                for (var r = [], o = e.cm && (e.cm.display.shift || e.extend), i = 0; i < e.sel.ranges.length; i++) r[i] = extendRange(e.sel.ranges[i], t[i], null, o);
            ...
            function filterSelectionChange(e, t, n) {
                var r = {
                    ...
                    update: function(t) {
                        this.ranges = [];
                        for (var n = 0; n < t.length; n++) this.ranges[n] = new be(clipPos(e, t[n].anchor), clipPos(e, t[n].head))
                    },
                    origin: n && n.origin
                };
                return signal(e, "beforeSelectionChange", e, r), e.cm && signal(e.cm, "beforeSelectionChange", e.cm, r), r.ranges != t.ranges ? normalizeSelection(r.ranges, r.ranges.length - 1) : t
            }

            function setSelectionReplaceHistory(e, t, n) {
                var r = e.history.done,
                    o = lst(r);
                o && o.ranges ? (r[r.length - 1] = t, setSelectionNoUndo(e, t, n)) : setSelection(e, t, n)
            }
            ...
            function setSelectionNoUndo(e, t, n) {
                (hasHandler(e, "beforeSelectionChange") || e.cm && hasHandler(e.cm, "beforeSelectionChange")) && (t = filterSelectionChange(e, t, n)), setSelectionInner(e, skipAtomicInSelection(e, t, n && n.bias || (cmp(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1), !0)), n && !1 === n.scroll || !e.cm || ensureCursorVisible(e.cm)
            }
            ...
            function skipAtomicInSelection(e, t, n, r) {
                for (var o, i = 0; i < t.ranges.length; i++) {
                    var a = t.ranges[i],
                        l = t.ranges.length == e.sel.ranges.length && e.sel.ranges[i],
                        s = skipAtomic(e, a.anchor, l && l.anchor, n, r),
                        c = skipAtomic(e, a.head, l && l.head, n, r);
                    (o || s != a.anchor || c != a.head) && (o || (o = t.ranges.slice(0, i)), o[i] = new be(s, c))
                }
                        ...
                        if ((null == l.from || (s.inclusiveLeft ? l.from <= t.ch : l.from < t.ch)) && (null == l.to || (s.inclusiveRight ? l.to >= t.ch : l.to > t.ch))) {
                            ...
                            if (n) {
                                var c = s.find(r < 0 ? 1 : -1),
                                    d = void 0;
                                if ((r < 0 ? s.inclusiveRight : s.inclusiveLeft) && (c = movePos(e, c, -r, c && c.line == t.line ? i : null)), c && c.line == t.line && (d = cmp(c, n)) && (r < 0 ? d < 0 : d > 0)) return skipAtomicInner(e, c, t, r, o)
                            }
                            var p = s.find(r < 0 ? -1 : 1);
                            return (r < 0 ? s.inclusiveLeft : s.inclusiveRight) && (p = movePos(e, p, r, p.line == t.line ? i : null)), p ? skipAtomicInner(e, p, t, r, o) : null
                        }
                    }
                return t
            }
            ...
            function skipAtomic(e, t, n, r, o) {
                var i = r || 1,
                    a = skipAtomicInner(e, t, n, i, o) || !o && skipAtomicInner(e, t, n, i, !0) || skipAtomicInner(e, t, n, -i, o) || !o && skipAtomicInner(e, t, n, -i, !0);
                return a || (e.cantEdit = !0, Pos(e.first, 0))
            }

            function movePos(e, t, n, r) {
                return n < 0 && 0 == t.ch ? t.line > e.first ? clipPos(e, Pos(t.line - 1)) : null : n > 0 && t.ch == (r || getLine(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? Pos(t.line + 1, 0) : null : new Pos(t.line, t.ch + n)
            }

            function selectAll(e) {
                e.setSelection(Pos(e.firstLine(), 0), Pos(e.lastLine()), N)
            }
            ...
            function filterChange(e, t, n) {
                ...
                return n && (r.update = function(t, n, o, i) {
                    t && (r.from = clipPos(e, t)), n && (r.to = clipPos(e, n)), o && (r.text = o), void 0 !== i && (r.origin = i)
                }), signal(e, "beforeChange", e, r), e.cm && signal(e.cm, "beforeChange", e.cm, r), r.canceled ? null : {
                    from: r.from,
                    to: r.to,
                    text: r.text,
                    origin: r.origin
            ...
            function makeChange(e, t, n) {
                ...
                if (!(hasHandler(e, "beforeChange") || e.cm && hasHandler(e.cm, "beforeChange")) || (t = filterChange(e, t, !0))) {
                    ...
                    if (r)
                        for (var o = r.length - 1; o >= 0; --o) makeChangeInner(e, {
                            from: r[o].from,
                            to: r[o].to,
                            text: o ? [""] : t.text,
                            origin: t.origin
            ...
            function makeChangeInner(e, t) {
                if (1 != t.text.length || "" != t.text[0] || 0 != cmp(t.from, t.to)) {
                    ...
                    addChangeToHistory(e, t, n, e.cm ? e.cm.curOp.id : NaN), makeChangeSingleDoc(e, t, n, stretchSpansOverChange(e, t));
                    var r = [];
                    linkedDocs(e, function(e, n) {
                        n || -1 != indexOf(r, e.history) || (rebaseHist(e.history, t), r.push(e.history)), makeChangeSingleDoc(e, t, null, stretchSpansOverChange(e, t))
                    })
                }
            }
            ...
            function makeChangeFromHistory(e, t, n) {
                ...
                if (!r || n) {
                    for (var o, i = e.history, a = e.sel, l = "undo" == t ? i.done : i.undone, s = "undo" == t ? i.undone : i.done, c = 0; c < l.length && (o = l[c], n ? !o.ranges || o.equals(e.sel) : o.ranges); c++);
                    if (c != l.length) {
                        for (i.lastOrigin = i.lastSelOrigin = null;;) {
                            if (!(o = l.pop()).ranges) {
                                if (r) return void l.push(o);
                                break
                            }
                            if (pushSelectionToHistory(o, s), n && !o.equals(e.sel)) return void setSelection(e, o, {
                                clearRedo: !1
                            });
                            a = o
                        }
                        var d = [];
                        pushSelectionToHistory(a, s), s.push({
                            changes: d,
                            generation: i.generation
                        }), i.generation = o.generation || ++i.maxGeneration;
                        for (var p = hasHandler(e, "beforeChange") || e.cm && hasHandler(e.cm, "beforeChange"), u = function(n) {
                                var r = o.changes[n];
                                if (r.origin = t, p && !filterChange(e, r, !1)) return l.length = 0, {};
                                d.push(historyChangeFromChange(e, r));
                                var i = n ? computeSelAfterChange(e, r) : lst(l);
                                makeChangeSingleDoc(e, r, i, mergeOldSpans(e, r)), !n && e.cm && e.cm.scrollIntoView({
                                    from: r.from,
                                    to: changeEnd(r)
                                });
                                var a = [];
                                linkedDocs(e, function(e, t) {
                                    t || -1 != indexOf(a, e.history) || (rebaseHist(e.history, r), a.push(e.history)), makeChangeSingleDoc(e, r, null, mergeOldSpans(e, r))
                                })
                            }, h = o.changes.length - 1; h >= 0; --h) {
                            var f = u(h);
                            if (f) return f.v
                        }
                    }
            ...
            function shiftDoc(e, t) {
                if (0 != t && (e.first += t, e.sel = new ve(map(e.sel.ranges, function(e) {
                        return new be(Pos(e.anchor.line + t, e.anchor.ch), Pos(e.head.line + t, e.head.ch))
            ...
            function makeChangeSingleDoc(e, t, n, r) {
                ...
                if (t.to.line < e.first) shiftDoc(e, t.text.length - 1 - (t.to.line - t.from.line));
                    ...
                    t.to.line > i && (t = {
                        ...
                        text: [t.text[0]],
                        origin: t.origin
                    }), t.removed = getBetween(e, t.from, t.to), n || (n = computeSelAfterChange(e, t)), e.cm ? makeChangeSingleDocInEditor(e.cm, t, r) : updateDoc(e, t, r), setSelectionNoUndo(e, n, N)
                }
            }
            ...
            function makeChangeSingleDocInEditor(e, t, n) {
                var r = e.doc,
                    ...
                    l = !1,
                    s = i.line;
                e.options.lineWrapping || (s = lineNo(visualLine(getLine(r, i.line))), r.iter(s, a.line + 1, function(e) {
                    if (e == o.maxLine) return l = !0, !0
                })), r.sel.contains(t.from, t.to) > -1 && signalCursorActivity(e), updateDoc(r, t, n, estimateHeight(e)), e.options.lineWrapping || (r.iter(s, i.line + t.text.length, function(e) {
                    var t = lineLength(e);
                    t > o.maxLineLength && (o.maxLine = e, o.maxLineLength = t, o.maxLineChanged = !0, l = !1)
                }), l && (e.curOp.updateMaxLine = !0)), retreatFrontier(r, i.line), startWorker(e, 400);
                var c = t.text.length - (a.line - i.line) - 1;
                t.full ? regChange(e) : i.line != a.line || 1 != t.text.length || isWholeLineUpdate(e.doc, t) ? regChange(e, i.line, a.line + 1, c) : regLineChange(e, i.line, "text");
                var d = hasHandler(e, "changes"),
                    p = hasHandler(e, "change");
                if (p || d) {
                    var u = {
                        from: i,
                        to: a,
                    ...
                    p && signalLater(e, "change", e, u), d && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(u)
                }
            ...
            function replaceRange(e, t, n, r, o) {
                ...
                "string" == typeof t && (t = e.splitLines(t)), makeChange(e, {
                    from: n,
                    to: r,
                    text: t,
                    origin: o
            ...
            function rebaseHistArray(e, t, n, r) {
                for (var o = 0; o < e.length; ++o) {
                    ...
                    if (i.ranges) {
                        ...
                        for (var l = 0; l < i.ranges.length; l++) rebaseHistSelSingle(i.ranges[l].anchor, t, n, r), rebaseHistSelSingle(i.ranges[l].head, t, n, r)
                    } else {
            ...
            function changeLine(e, t, n, r) {
                var o = t,
                    i = t;
                return "number" == typeof t ? i = getLine(e, clipLine(e, t)) : o = lineNo(t), null == o ? null : (r(i, o) && e.cm && regLineChange(e.cm, o, n), i)
            }
            ...
            be.prototype.from = function() {
                ...
                removeInner: function(e, t) {
                    ...
                    if (this.size - t < 25 && (this.children.length > 1 || !(this.children[0] instanceof LeafChunk))) {
                        var l = [];
                        this.collapse(l), this.children = [new LeafChunk(l)], this.children[0].parent = this
                    }
                },
                collapse: function(e) {
                        ...
                        if (e <= i) {
                            if (o.insertInner(e, t, n), o.lines && o.lines.length > 50) {
                                for (var a = o.lines.length % 25 + 25, l = a; l < o.lines.length;) {
                                    var s = new LeafChunk(o.lines.slice(l, l += 25));
                                    o.height -= s.height, this.children.splice(++r, 0, s), s.parent = this
                                }
            ...
            function addLineWidget(e, t, n, r) {
                var o = new ye(e, n, r),
                    i = e.cm;
                return i && o.noHScroll && (i.display.alignWidgets = !0), changeLine(e, t, "widget", function(t) {
                    var n = t.widgets || (t.widgets = []);
                    if (null == o.insertAt ? n.push(o) : n.splice(Math.min(n.length - 1, Math.max(0, o.insertAt)), 0, o), o.line = t, i && !lineIsHidden(e, t)) {
                        var r = heightAtLine(t) < e.scrollTop;
                        updateLineHeight(t, t.height + widgetHeight(o)), r && addToScrollTop(i, o.height), i.curOp.forceUpdate = !0
                    }
                    return !0
                }), i && signalLater(i, "lineWidgetAdded", i, o, "number" == typeof t ? t : lineNo(t)), o
            }
            ye.prototype.clear = function() {
                ...
                if (null != r && t) {
                    ...
                    updateLineHeight(n, Math.max(0, n.height - i)), e && (runInOp(e, function() {
                ...
                o && (updateLineHeight(r, r.height + o), n && runInOp(n, function() {
                    n.curOp.forceUpdate = !0, adjustScrollWhenAboveVisible(n, r, o), signalLater(n, "lineWidgetChanged", n, e, lineNo(r))
                }))
            }, eventMixin(ye);
            var xe = 0,
                we = function(e, t) {
            ...
            function markText(e, t, n, r, o) {
                ...
                var i = new we(e, o),
                    a = cmp(t, n);
                if (r && copyObj(r, i, !1), a > 0 || 0 == a && !1 !== i.clearWhenEmpty) return i;
                if (i.replacedWith && (i.collapsed = !0, i.widgetNode = eltP("span", [i.replacedWith], "CodeMirror-widget"), r.handleMouseEvents || i.widgetNode.setAttribute("cm-ignore-events", "true"), r.insertLeft && (i.widgetNode.insertLeft = !0)), i.collapsed) {
                    if (conflictingCollapsedRange(e, t.line, t, n, i) || t.line != n.line && conflictingCollapsedRange(e, n.line, t, n, i)) throw new Error("Inserting collapsed marker partially overlapping an existing one");
                    B = !0
                }
                i.addToHistory && addChangeToHistory(e, {
                    from: t,
                    to: n,
                    origin: "markText"
                }, e.sel, NaN);
                ...
                if (e.iter(s, n.line + 1, function(e) {
                        c && i.collapsed && !c.options.lineWrapping && visualLine(e) == c.display.maxLine && (l = !0), i.collapsed && s != t.line && updateLineHeight(e, 0), addMarkedSpan(e, new MarkedSpan(i, s == t.line ? t.ch : null, s == n.line ? n.ch : null)), ++s
                    }), i.collapsed && e.iter(t.line, n.line + 1, function(t) {
                        lineIsHidden(e, t) && updateLineHeight(t, 0)
                    }), i.clearOnEnter && j(i, "beforeCursorEnter", function() {
                        return i.clear()
                    }), i.readOnly && (I = !0, (e.history.done.length || e.history.undone.length) && e.clearHistory()), i.collapsed && (i.id = ++xe, i.atomic = !0), c) {
                    if (l && (c.curOp.updateMaxLine = !0), i.collapsed) regChange(c, t.line, n.line + 1);
                    else if (i.className || i.title || i.startStyle || i.endStyle || i.css)
                        for (var d = t.line; d <= n.line; d++) regLineChange(c, d, "text");
            ...
            we.prototype.clear = function() {
                if (!this.explicitlyCleared) {
                    ...
                    for (var r = null, o = null, i = 0; i < this.lines.length; ++i) {
                        var a = this.lines[i],
                            l = getMarkedSpanFor(a.markedSpans, this);
                        e && !this.collapsed ? regLineChange(e, lineNo(a), "text") : e && (null != l.to && (o = lineNo(a)), null != l.from && (r = lineNo(a))), a.markedSpans = removeMarkedSpan(a.markedSpans, l), null == l.from && this.collapsed && !lineIsHidden(this.doc, a) && e && updateLineHeight(a, textHeight(e.display))
                    }
                    if (e && this.collapsed && !e.options.lineWrapping)
                        for (var s = 0; s < this.lines.length; ++s) {
                            var c = visualLine(this.lines[s]),
                                d = lineLength(c);
                            d > e.display.maxLineLength && (e.display.maxLine = c, e.display.maxLineLength = d, e.display.maxLineChanged = !0)
                        }
                    null != r && e && this.collapsed && regChange(e, r, o + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && reCheckSelection(e.doc)), e && signalLater(e, "markerCleared", e, this, r, o), t && endOperation(e), this.parent && this.parent.clear()
                }
                ...
                for (var o = 0; o < this.lines.length; ++o) {
                    ...
                    if (null != a.from && (n = Pos(t ? i : lineNo(i), a.from), -1 == e)) return n;
                ...
                var e = this,
                    ...
                    n = this,
                    r = this.doc.cm;
                t && r && runInOp(r, function() {
                    var o = t.line,
                        i = lineNo(t.line),
                        a = findViewForLine(r, i);
                    if (a && (clearLineMeasurementCacheFor(a), r.curOp.selectionChanged = r.curOp.forceUpdate = !0), r.curOp.updateMaxLine = !0, !lineIsHidden(n.doc, o) && null != n.height) {
                        var l = n.height;
                        n.height = null;
                        var s = widgetHeight(n) - l;
                        s && updateLineHeight(o, o.height + s)
                    }
                    signalLater(r, "markerChanged", r, e)
                })
            }, we.prototype.attachLine = function(e) {
                ...
                this.lines.push(e)
            }, we.prototype.detachLine = function(e) {
            ...
            function markTextShared(e, t, n, r, o) {
                ...
                return linkedDocs(e, function(e) {
                    l && (r.widgetNode = l.cloneNode(!0)), i.push(markText(e, clipPos(e, t), clipPos(e, n), r, o));
            ...
            function copySharedMarkers(e, t) {
                for (var n = 0; n < t.length; n++) {
                    var r = t[n],
                        ...
                        a = e.clipPos(o.to);
                    if (cmp(i, a)) {
                        var l = markText(e, i, a, r.primary, r.primary.type);
            ...
            function detachSharedMarkers(e) {
                for (var t = function(t) {
                        ...
                        for (var o = 0; o < n.markers.length; o++) {
                            var i = n.markers[o]; - 1 == indexOf(r, i.doc) && (i.parent = null, n.markers.splice(o--, 1))
                        }
            ...
            var ke = 0,
                Se = function(e, t, n, r, o) {
                    ...
                    null == n && (n = 0), BranchChunk.call(this, [new LeafChunk([new re("", null)])]), this.first = n, this.scrollTop = this.scrollLeft = 0, this.cantEdit = !1, this.cleanGeneration = 1, this.modeFrontier = this.highlightFrontier = n;
                    var i = Pos(n, 0);
                    this.sel = simpleSelection(i), this.history = new History(null), this.id = ++ke, this.modeOption = t, this.lineSep = r, this.direction = "rtl" == o ? "rtl" : "ltr", this.extend = !1, "string" == typeof e && (e = this.splitLines(e)), updateDoc(this, {
                        from: i,
                        to: i,
                        text: e
                    }), setSelection(this, simpleSelection(i), N)
                };
            Se.prototype = createObj(BranchChunk.prototype, {
                ...
                setValue: docMethodOp(function(e) {
                    ...
                    makeChange(this, {
                        ...
                        origin: "setValue",
                        full: !0
                    }, !0), this.cm && scrollToCoords(this.cm, 0, 0), setSelection(this, simpleSelection(t), N)
                }),
                ...
                setSelections: docMethodOp(function(e, t, n) {
                    if (e.length) {
                        for (var r = [], o = 0; o < e.length; o++) r[o] = new be(clipPos(this, e[o].anchor), clipPos(this, e[o].head));
                        null == t && (t = Math.min(e.length - 1, this.sel.primIndex)), setSelection(this, normalizeSelection(r, t), n)
                    }
                }),
                addSelection: docMethodOp(function(e, t, n) {
                    var r = this.sel.ranges.slice(0);
                    r.push(new be(clipPos(this, e), clipPos(this, t || e))), setSelection(this, normalizeSelection(r, r.length - 1), n)
                }),
                ...
                replaceSelections: docMethodOp(function(e, t, n) {
                    ...
                    for (var l = t && "end" != t && computeReplacedSel(this, r, t), s = r.length - 1; s >= 0; s--) makeChange(this, r[s]);
                    l ? setSelectionReplaceHistory(this, l) : this.cm && ensureCursorVisible(this.cm)
                }),
                ...
                clearGutter: docMethodOp(function(e) {
                    ...
                    this.iter(function(n) {
                        n.gutterMarkers && n.gutterMarkers[e] && changeLine(t, n, "gutter", function() {
                ...
                findMarks: function(e, t, n) {
                    ...
                    return this.iter(e.line, t.line + 1, function(i) {
                        ...
                        if (a)
                            for (var l = 0; l < a.length; l++) {
                                var s = a[l];
                                null != s.to && o == e.line && e.ch >= s.to || null == s.from && o != e.line || null != s.from && o == t.line && s.from >= t.ch || n && !n(s.marker) || r.push(s.marker.parent || s.marker)
                            }++o
                    }), r
                },
                ...
                linkedDoc: function(e) {
                    ...
                    var r = new Se(getLines(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction);
                ...
                unlinkDoc: function(e) {
                    ...
                    if (e.history == this.history) {
                        ...
                        linkedDocs(e, function(e) {
                            return n.push(e.id)
                        }, !0), e.history = new History(null), e.history.done = copyHistoryArray(this.history.done, n), e.history.undone = copyHistoryArray(this.history.undone, n)
                    }
                },
                    ...
                    if (n && !t.isReadOnly())
                        if (r && r.length && window.FileReader && window.File)
                                    ...
                                    if (!t.options.allowDropFileTypes || -1 != indexOf(t.options.allowDropFileTypes, e.type)) {
                                        ...
                                        a.onload = operation(t, function() {
                                            ...
                                            if (/[\x00-\x08\x0e-\x1f]{2}/.test(e) && (e = ""), i[r] = e, ++l == o) {
                                                ...
                                                makeChange(t.doc, s), setSelectionReplaceHistory(t.doc, simpleSelection(n, changeEnd(s)))
                                            }
                                        }), a.readAsText(e)
                                    }
                                }, c = 0; c < o; ++c) s(r[c], c);
                            ...
                            try {
                                ...
                                if (d) {
                                    var p;
                                    if (t.state.draggingText && !t.state.draggingText.copy && (p = t.listSelections()), setSelectionNoUndo(t.doc, simpleSelection(n, n)), p)
                                        for (var u = 0; u < p.length; ++u) replaceRange(t.doc, "", p[u].anchor, p[u].head, "drag");
            ...
            function onDragStart(e, t) {
                ...
                else if (!signalDOMEvent(e, t) && !eventInWidget(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.effectAllowed = "copyMove", t.dataTransfer.setDragImage && !u)) {
            ...
            function onDragOver(e, t) {
                ...
                if (n) {
                    ...
                    drawSelectionCursor(e, n, r), e.display.dragCursor || (e.display.dragCursor = elt("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)), removeChildrenAndAdd(e.display.dragCursor, r)
                }
            }
            ...
            for (var Te = {
                    ...
                    63277: "PageDown",
                    63302: "Insert"
                }, Oe = 0; Oe < 10; Oe++) Te[Oe + 48] = Te[Oe + 96] = String(Oe);
            for (var Pe = 65; Pe <= 90; Pe++) Te[Pe] = String.fromCharCode(Pe);
            for (var Ne = 1; Ne <= 12; Ne++) Te[Ne + 111] = Te[Ne + 63235] = "F" + Ne;
            var Ae = {};
            ...
            function normalizeKeyMap(e) {
                ...
                for (var n in e)
                    if (e.hasOwnProperty(n)) {
                        ...
                        for (var o = map(n.split(" "), normalizeKeyName), i = 0; i < o.length; i++) {
                            var a = void 0,
                                l = void 0;
                            i == o.length - 1 ? (l = o.join(" "), a = r) : (l = o.slice(0, i + 1).join(" "), a = "...");
                            var s = t[l];
                            if (s) {
            ...
            function lookupKey(e, t, n, r) {
                ...
                if (t.fallthrough) {
                    if ("[object Array]" != Object.prototype.toString.call(t.fallthrough)) return lookupKey(e, t.fallthrough, n, r);
            ...
            function endOfLine(e, t, n, r, o) {
                if (e) {
                    ...
                    if (i) {
                        var a, l = o < 0 ? lst(i) : i[0],
                            s = o < 0 == (1 == l.level) ? "after" : "before";
                        if (l.level > 0 || "rtl" == t.doc.direction) {
                            var c = prepareMeasureForLine(t, n);
                            a = o < 0 ? n.text.length - 1 : 0;
                            var d = measureCharPrepared(t, c, a).top;
                            a = findFirst(function(e) {
                                return measureCharPrepared(t, c, e).top == d
                            }, o < 0 == (1 == l.level) ? l.from : l.to - 1, a), "before" == s && (a = moveCharLogically(n, a, 1))
                        } else a = o < 0 ? l.to : l.from;
            ...
            function moveVisually(e, t, n, r) {
                ...
                var i = getBidiPartAt(o, n.ch, n.sticky),
                    a = o[i];
                if ("ltr" == e.doc.direction && a.level % 2 == 0 && (r > 0 ? a.to > n.ch : a.from < n.ch)) return moveLogically(t, n, r);
                var l, s = function(e, n) {
                        return moveCharLogically(t, e instanceof Pos ? e.ch : e, n)
                    },
                    c = function(n) {
                        return e.options.lineWrapping ? (l = l || prepareMeasureForLine(e, t), wrappedLineExtentChar(e, t, l, n)) : {
                            begin: 0,
                            end: t.text.length
                        }
                    },
                    d = c("before" == n.sticky ? s(n, -1) : n.ch);
                if ("rtl" == e.doc.direction || 1 == a.level) {
                    var p = 1 == a.level == r < 0,
                        u = s(n, p ? 1 : -1);
                    if (null != u && (p ? u <= a.to && u <= d.end : u >= a.from && u >= d.begin)) {
                        var h = p ? "before" : "after";
                        return new Pos(n.line, u, h)
                    }
                }
                var f = function(e, t, r) {
                        for (var i = function(e, t) {
                                return t ? new Pos(n.line, s(e, 1), "before") : new Pos(n.line, e, "after")
                            }; e >= 0 && e < o.length; e += t) {
                            var a = o[e],
                                l = t > 0 == (1 != a.level),
                                c = l ? r.begin : s(r.end, -1);
                            if (a.from <= c && c < a.to) return i(c, l);
                            if (c = l ? a.from : s(a.to, -1), r.begin <= c && c < r.end) return i(c, l)
                        }
                    },
                    m = f(i + r, r, d);
                if (m) return m;
                var g = r > 0 ? d.end : s(d.begin, -1);
                return null == g || r > 0 && g == t.text.length || !(m = f(r > 0 ? 0 : o.length - 1, r, c(g))) ? null : m
            }
            Ae.basic = {
                Left: "goCharLeft",
                Right: "goCharRight",
            ...
            }, Ae.default = b ? Ae.macDefault : Ae.pcDefault;
            var De = {
                selectAll: selectAll,
                singleSelection: function(e) {
                    return e.setSelection(e.getCursor("anchor"), e.getCursor("head"), N)
                },
                killLine: function(e) {
                    ...
                    return runInOp(e, function() {
                        for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
                            if (t[r].empty()) {
                                ...
                                if (i)
                                    if (o.ch == i.length && (o = new Pos(o.line, o.ch - 1)), o.ch > 0) o = new Pos(o.line, o.ch + 1), e.replaceRange(i.charAt(o.ch - 1) + i.charAt(o.ch - 2), Pos(o.line, o.ch - 2), o, "+transpose");
                                    else if (o.line > e.doc.first) {
                                    var a = getLine(e.doc, o.line - 1).text;
                                    a && (o = new Pos(o.line, 1), e.replaceRange(i.charAt(0) + e.doc.lineSeparator() + a.charAt(a.length - 1), Pos(o.line - 1, a.length - 1), o, "+transpose"))
                                }
                                n.push(new be(o, o))
                            }
                        e.setSelections(n)
            ...
            function doHandleBinding(e, t, n) {
                ...
                var r = e.display.shift,
                    o = !1;
                try {
                    e.isReadOnly() && (e.state.suppressEdits = !0), n && (e.display.shift = !1), o = t(e) != P
                } finally {
            ...
            function dispatchKey(e, t, n, r) {
                ...
                if (o) {
                    ...
                    if (/\'$/.test(t) ? e.state.keySeq = null : Ee.set(50, function() {
                            e.state.keySeq == o && (e.state.keySeq = null, e.display.input.reset())
                        }), dispatchKeyInner(e, o + " " + t, n, r)) return !0
                }
            ...
            function dispatchKeyInner(e, t, n, r) {
                ...
                return "multi" == o && (e.state.keySeq = t), "handled" == o && signalLater(e, "keyHandled", e, t, n), "handled" != o && "multi" != o || (e_preventDefault(n), restartBlink(e)), !!o
            }

            function handleKeyBinding(e, t) {
                var n = keyName(t, !0);
                return !!n && (t.shiftKey && !e.state.keySeq ? dispatchKey(e, "Shift-" + n, t, function(t) {
            ...
            function onKeyDown(e) {
                ...
                if (t.curOp.focus = activeElt(), !signalDOMEvent(t, e)) {
                    ...
                    p && (He = r ? n : null, !r && 88 == n && !$ && (b ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")), 18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || showCrossHair(t)
                }
            }
            ...
            function showCrossHair(e) {
                ...
                addClass(t, "CodeMirror-crosshair"), j(document, "keyup", up), j(document, "mouseover", up)
            }
            ...
            function onKeyPress(e) {
                ...
                if (!(eventInWidget(t.display, e) || signalDOMEvent(t, e) || e.ctrlKey && !e.altKey || b && e.metaKey)) {
                    var n = e.keyCode,
                        r = e.charCode;
                    if (p && n == He) return He = null, void e_preventDefault(e);
                    if (!p || e.which && !(e.which < 10) || !handleKeyBinding(t, e)) {
                        var o = String.fromCharCode(null == r ? n : r);
                        "\b" != o && (handleCharBinding(t, e, o) || t.display.input.onKeyPress(e))
                    }
                }
            }
            var We, Ie, Be = function(e, t, n) {
                this.time = e, this.pos = t, this.button = n
            };

            function clickRepeat(e, t) {
                var n = +new Date;
                return Ie && Ie.compare(n, e, t) ? (We = Ie = null, "triple") : We && We.compare(n, e, t) ? (Ie = new Be(n, e, t), We = null, "double") : (We = new Be(n, e, t), Ie = null, "single")
            }
            ...
            function onMouseDown(e) {
                ...
                if (!(signalDOMEvent(t, e) || n.activeTouch && n.input.supportsTouch()))
                    if (n.input.ensurePolled(), n.shift = e.shiftKey, eventInWidget(n, e)) s || (n.scroller.draggable = !1, setTimeout(function() {
                    ...
                    window.focus(), 1 == o && t.state.selectingText && t.state.selectingText(e), r && handleMappedButton(t, o, r, i, e) || (1 == o ? r ? leftButtonDown(t, r, i, e) : e_target(e) == n.scroller && e_preventDefault(e) : 2 == o ? (r && extendSelection(t.doc, r), setTimeout(function() {
                        return n.input.focus()
                    }, 20)) : 3 == o && (k ? onContextMenu(t, e) : delayBlurEvent(t)))
                }
            }

            function handleMappedButton(e, t, n, r, o) {
                var i = "Click";
                return "double" == r ? i = "Double" + i : "triple" == r && (i = "Triple" + i), dispatchKey(e, addModifierNames(i = (1 == t ? "Left" : 2 == t ? "Middle" : "Right") + i, o), o, function(t) {
            ...
            function configureMouse(e, t, n) {
                var r = e.getOption("configureMouse"),
                    o = r ? r(e, t, n) : {};
                if (null == o.unit) {
                    var i = y ? n.shiftKey && n.metaKey : n.altKey;
                    o.unit = i ? "rectangle" : "single" == t ? "char" : "double" == t ? "word" : "line"
                }
                return (null == o.extend || e.doc.extend) && (o.extend = e.doc.extend || n.shiftKey), null == o.addNew && (o.addNew = b ? n.metaKey : n.ctrlKey), null == o.moveOnDrag && (o.moveOnDrag = !(b ? n.altKey : n.ctrlKey)), o
            }

            function leftButtonDown(e, t, n, r) {
                a ? setTimeout(bind(ensureFocus, e), 0) : e.curOp.focus = activeElt();
                var o, i = configureMouse(e, n, r),
                    l = e.doc.sel;
                e.options.dragDrop && _ && !e.isReadOnly() && "single" == n && (o = l.contains(t)) > -1 && (cmp((o = l.ranges[o]).from(), t) < 0 || t.xRel > 0) && (cmp(o.to(), t) > 0 || t.xRel < 0) ? leftButtonStartDrag(e, r, t, i) : leftButtonSelect(e, r, t, i)
            }
            ...
            function leftButtonStartDrag(e, t, n, r) {
                var o = e.display,
                    ...
                    c = operation(e, function(t) {
                        s && (o.scroller.draggable = !1), e.state.draggingText = !1, off(o.wrapper.ownerDocument, "mouseup", c), off(o.wrapper.ownerDocument, "mousemove", d), off(o.scroller, "dragstart", p), off(o.scroller, "drop", c), i || (e_preventDefault(t), r.addNew || extendSelection(e.doc, n, null, null, r.extend), s || a && 9 == l ? setTimeout(function() {
                ...
                s && (o.scroller.draggable = !0), e.state.draggingText = c, c.copy = !r.moveOnDrag, o.scroller.dragDrop && o.scroller.dragDrop(), j(o.wrapper.ownerDocument, "mouseup", c), j(o.wrapper.ownerDocument, "mousemove", d), j(o.scroller, "dragstart", p), j(o.scroller, "drop", c), delayBlurEvent(e), setTimeout(function() {
                    return o.input.focus()
                }, 20)
            }

            function rangeForUnit(e, t, n) {
                if ("char" == n) return new be(t, t);
                if ("word" == n) return e.findWordAt(t);
                if ("line" == n) return new be(Pos(t.line, 0), clipPos(e.doc, Pos(t.line + 1, 0)));
                var r = n(e, t);
                return new be(r.from, r.to)
            }
            ...
            function leftButtonSelect(e, t, n, r) {
                ...
                var a, l, s = i.sel,
                    c = s.ranges;
                if (r.addNew && !r.extend ? (l = i.sel.contains(n), a = l > -1 ? c[l] : new be(n, n)) : (a = i.sel.primary(), l = i.sel.primIndex), "rectangle" == r.unit) r.addNew || (a = new be(n, n)), n = posFromMouse(e, t, !0, !0), l = -1;
                else {
                    var d = rangeForUnit(e, n, r.unit);
                    a = r.extend ? extendRange(a, d.anchor, d.head, r.extend) : d
                }
                r.addNew ? -1 == l ? (l = c.length, setSelection(i, normalizeSelection(c.concat([a]), l), {
                    scroll: !1,
                    origin: "*mouse"
                })) : c.length > 1 && c[l].empty() && "char" == r.unit && !r.extend ? (setSelection(i, normalizeSelection(c.slice(0, l).concat(c.slice(l + 1)), 0), {
                    scroll: !1,
                    origin: "*mouse"
                }), s = i.sel) : replaceOneSelection(i, l, a, A) : (l = 0, setSelection(i, new ve([a], 0), A), s = i.sel);
                var p = n;

                function extendTo(t) {
                    if (0 != cmp(p, t))
                        if (p = t, "rectangle" == r.unit) {
                            for (var o = [], c = e.options.tabSize, d = countColumn(getLine(i, n.line).text, n.ch, c), u = countColumn(getLine(i, t.line).text, t.ch, c), h = Math.min(d, u), f = Math.max(d, u), m = Math.min(n.line, t.line), g = Math.min(e.lastLine(), Math.max(n.line, t.line)); m <= g; m++) {
                                var v = getLine(i, m).text,
                                    b = findColumn(v, h, c);
                                h == f ? o.push(new be(Pos(m, b), Pos(m, b))) : v.length > b && o.push(new be(Pos(m, b), Pos(m, findColumn(v, f, c))))
                            }
                            o.length || o.push(new be(n, n)), setSelection(i, normalizeSelection(s.ranges.slice(0, l).concat(o), l), {
                                origin: "*mouse",
                                scroll: !1
                            }), e.scrollIntoView(t)
                        } else {
                            var y, x = a,
                                w = rangeForUnit(e, t, r.unit),
                                C = x.anchor;
                            cmp(w.anchor, C) > 0 ? (y = w.head, C = minPos(x.from(), w.anchor)) : (y = w.anchor, C = maxPos(x.to(), w.head));
                            var k = s.ranges.slice(0);
                            k[l] = bidiSimplify(e, new be(clipPos(i, C), y)), setSelection(i, normalizeSelection(k, l), A)
                        }
                }
                var u = o.wrapper.getBoundingClientRect(),
                    h = 0;
                ...
                function extend(t) {
                    ...
                    if (a)
                        if (0 != cmp(a, p)) {
                            ...
                            var l = visibleLines(o, i);
                            (a.line >= l.to || a.line < l.from) && setTimeout(operation(e, function() {
                                h == n && extend(t)
                            }), 150)
                        } else {
                            var s = t.clientY < u.top ? -20 : t.clientY > u.bottom ? 20 : 0;
                            s && setTimeout(operation(e, function() {
                                h == n && (o.scroller.scrollTop += s, extend(t))
                            }), 50)
                        }
                }

                function done(t) {
                    e.state.selectingText = !1, h = 1 / 0, e_preventDefault(t), o.input.focus(), off(o.wrapper.ownerDocument, "mousemove", f), off(o.wrapper.ownerDocument, "mouseup", m), i.history.lastSelOrigin = null
                }
                var f = operation(e, function(e) {
                        0 !== e.buttons && e_button(e) ? extend(e) : done(e)
                    }),
                    m = operation(e, done);
                e.state.selectingText = m, j(o.wrapper.ownerDocument, "mousemove", f), j(o.wrapper.ownerDocument, "mouseup", m)
            }
            ...
            function bidiSimplify(e, t) {
                ...
                if (r.line != n.line) s = (r.line - n.line) * ("ltr" == e.doc.direction ? 1 : -1) > 0;
                    ...
                    var d = getBidiPartAt(i, r.ch, r.sticky),
                        p = d - a || (r.ch - n.ch) * (1 == l.level ? -1 : 1);
                    s = d == c - 1 || d == c ? p < 0 : p > 0
                }
                var u = i[c + (s ? -1 : 0)],
                    h = s == (1 == u.level),
                    f = h ? u.from : u.to,
                    m = h ? "after" : "before";
                return n.ch == f && n.sticky == m ? t : new be(new Pos(n.line, f, m), r)
            }
            ...
            function gutterEvent(e, t, n, r) {
                ...
                if (i > l.bottom || !hasHandler(e, n)) return e_defaultPrevented(t);
                i -= l.top - a.viewOffset;
                for (var s = 0; s < e.options.gutters.length; ++s) {
                    var c = a.gutters.childNodes[s];
                    if (c && c.getBoundingClientRect().right >= o) return signal(e, n, e, lineAtHeight(e.doc, i), e.options.gutters[s], t), e_defaultPrevented(t)
                }
            }
            ...
            function onContextMenu(e, t) {
                eventInWidget(e.display, t) || contextMenuInGutter(e, t) || signalDOMEvent(e, t, "contextmenu") || e.display.input.onContextMenu(t)
            }

            function contextMenuInGutter(e, t) {
                return !!hasHandler(e, "gutterContextMenu") && gutterEvent(e, t, "gutterContextMenu", !1)
            }
            ...
            Be.prototype.compare = function(e, t, n) {
            ...
            function dragDropChanged(e, t, n) {
                if (!t != !(n && n != Fe)) {
                    var r = e.display.dragFunctions,
                        o = t ? j : off;
                    o(e.display.scroller, "dragstart", r.start), o(e.display.scroller, "dragenter", r.enter), o(e.display.scroller, "dragover", r.over), o(e.display.scroller, "dragleave", r.leave), o(e.display.scroller, "drop", r.drop)
                }
            }
            ...
            function CodeMirror$1(e, t) {
                ...
                var r = t.value;
                "string" == typeof r && (r = new Se(r, t.mode, null, t.lineSeparator, t.direction)), this.doc = r;
                var o, i = new CodeMirror$1.inputStyles[t.inputStyle](this),
                    c = this.display = new Display(e, r, i);
                for (var d in c.wrapper.CodeMirror = this, updateGutters(this), themeChanged(this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), initScrollbars(this), this.state = {
                        keyMaps: [],
                        overlays: [],
                        modeGen: 0,
                        overwrite: !1,
                    ...
                    }, 20), registerEventHandlers(this), Me || (j(window, "resize", function() {
                        null == o && (o = setTimeout(function() {
                            o = null, forEachCodeMirror(onResize)
                        }, 100))
                    }), j(window, "blur", function() {
                        return forEachCodeMirror(onBlur)
                    }), Me = !0), startOperation(this), this.curOp.forceUpdate = !0, attachDoc(this, r), t.autofocus && !v || this.hasFocus() ? setTimeout(bind(onFocus, this), 20) : onBlur(this), Re) Re.hasOwnProperty(d) && Re[d](n, t[d], Fe);
                maybeUpdateLineNumberWidth(this), t.finishInit && t.finishInit(this);
                for (var p = 0; p < je.length; ++p) je[p](n);
                endOperation(this), s && t.lineWrapping && "optimizelegibility" == getComputedStyle(c.lineDiv).textRendering && (c.lineDiv.style.textRendering = "auto")
            }

            function registerEventHandlers(e) {
                var t = e.display;
                j(t.scroller, "mousedown", operation(e, onMouseDown)), j(t.scroller, "dblclick", a && l < 11 ? operation(e, function(t) {
                ...
                }), k || j(t.scroller, "contextmenu", function(t) {
                ...
                j(t.scroller, "touchstart", function(o) {
                    if (!signalDOMEvent(e, o) && !isMouseLikeTouchEvent(o) && !clickInGutter(e, o)) {
                    ...
                    if (r && !eventInWidget(t, n) && null != r.left && !r.moved && new Date - r.start < 300) {
                        var o, i = e.coordsChar(t.activeTouch, "page");
                        o = !r.prev || farAway(r, r.prev) ? new be(i, i) : !r.prev.prev || farAway(r, r.prev.prev) ? e.findWordAt(i) : new be(Pos(i.line, 0), clipPos(e.doc, Pos(i.line + 1, 0))), e.setSelection(o.anchor, o.head), e.focus(), e_preventDefault(n)
                    }
                    finishTouch()
                }), j(t.scroller, "touchcancel", finishTouch), j(t.scroller, "scroll", function() {
                    t.scroller.clientHeight && (updateScrollTop(e, t.scroller.scrollTop), setScrollLeft(e, t.scroller.scrollLeft, !0), signal(e, "scroll", e))
                ...
                }), j(o, "keydown", operation(e, onKeyDown)), j(o, "keypress", operation(e, onKeyPress)), j(o, "focus", function(t) {
                    return onFocus(e, t)
                }), j(o, "blur", function(t) {
                    return onBlur(e, t)
                })
            ...
            function indentLine(e, t, n, r) {
                var o, i = e.doc;
                null == n && (n = "add"), "smart" == n && (i.mode.indent ? o = getContextBefore(e, t).state : n = "prev");
                var a = e.options.tabSize,
                    l = getLine(i, t),
                    s = countColumn(l.text, null, a);
                l.stateAfter && (l.stateAfter = null);
                var c, d = l.text.match(/^\s*/)[0];
                if (r || /\S/.test(l.text)) {
                    if ("smart" == n && ((c = i.mode.indent(o, l.text.slice(d.length), l.text)) == P || c > 150)) {
                        if (!r) return;
                        n = "prev"
                    }
                } else c = 0, n = "not";
                "prev" == n ? c = t > i.first ? countColumn(getLine(i, t - 1).text, null, a) : 0 : "add" == n ? c = s + e.options.indentUnit : "subtract" == n ? c = s - e.options.indentUnit : "number" == typeof n && (c = s + n), c = Math.max(0, c);
                var p = "",
                    u = 0;
                if (e.options.indentWithTabs)
                    for (var h = Math.floor(c / a); h; --h) u += a, p += "\t";
                if (u < c && (p += spaceStr(c - u)), p != d) return replaceRange(i, p, Pos(t, 0), Pos(t, d.length), "+input"), l.stateAfter = null, !0;
                for (var f = 0; f < i.sel.ranges.length; f++) {
                    var m = i.sel.ranges[f];
                    if (m.head.line == t && m.head.ch < d.length) {
                        var g = Pos(t, d.length);
                        replaceOneSelection(i, f, new be(g, g));
                        break
                    }
                }
            }
            ...
            function applyTextInput(e, t, n, r, o) {
                ...
                var a, l = e.state.pasteIncoming || "paste" == o,
                    s = K(t),
                    c = null;
                if (l && r.ranges.length > 1)
                    if (Ve && Ve.text.join("\n") == t) {
                        if (r.ranges.length % Ve.text.length == 0) {
                            c = [];
                            for (var d = 0; d < Ve.text.length; d++) c.push(i.splitLines(Ve.text[d]))
                        }
                    } else s.length == r.ranges.length && e.options.pasteLinesPerSelection && (c = map(s, function(e) {
                        return [e]
                    }));
                for (var p = r.ranges.length - 1; p >= 0; p--) {
                    var u = r.ranges[p],
                        h = u.from(),
                        f = u.to();
                    u.empty() && (n && n > 0 ? h = Pos(h.line, h.ch - n) : e.state.overwrite && !l ? f = Pos(f.line, Math.min(getLine(i, f.line).text.length, f.ch + lst(s).length)) : Ve && Ve.lineWise && Ve.text.join("\n") == t && (h = f = Pos(h.line, 0))), a = e.curOp.updateInput;
                    var m = {
                        from: h,
                        to: f,
                        text: c ? c[p % c.length] : s,
                        origin: o || (l ? "paste" : e.state.cutIncoming ? "cut" : "+input")
                    };
                    makeChange(e.doc, m), signalLater(e, "inputRead", e, m)
                }
                t && !l && triggerElectric(e, t), ensureCursorVisible(e), e.curOp.updateInput = a, e.curOp.typing = !0, e.state.pasteIncoming = e.state.cutIncoming = !1
            }
                    ...
                    for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                        ...
                        if (!(o.head.ch > 100 || r && n.ranges[r - 1].head.line == o.head.line)) {
                            var i = e.getModeAt(o.head),
                                a = !1;
                            if (i.electricChars) {
                                for (var l = 0; l < i.electricChars.length; l++)
                                    if (t.indexOf(i.electricChars.charAt(l)) > -1) {
                                        a = indentLine(e, o.head.line, "smart");
                                        break
                                    }
                            } else i.electricInput && i.electricInput.test(getLine(e.doc, o.head.line).text.slice(0, o.head.ch)) && (a = indentLine(e, o.head.line, "smart"));
            ...
            function hiddenTextarea() {
                ...
                return s ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), m && (e.style.border = "1px solid black"), disableBrowserMagic(e), t
            }
            ...
            function findPosH(e, t, n, r, o) {
                ...
                function moveOnce(r) {
                    var i, a;
                    if (null == (i = o ? moveVisually(e.cm, l, t, n) : moveLogically(l, t, n))) {
                        if (r || (a = t.line + n) < e.first || a >= e.first + e.size || (t = new Pos(a, t.ch, t.sticky), !(l = getLine(e, a)))) return !1;
                        t = endOfLine(o, e.cm, l, t.line, n)
                    } else t = i;
                    return !0
                }
                if ("char" == r) moveOnce();
                    ...
                    for (var s = null, c = "group" == r, d = e.cm && e.cm.getHelper(t, "wordChars"), p = !0; !(n < 0) || moveOnce(!p); p = !1) {
                        var u = l.text.charAt(t.ch) || "\n",
                            h = isWordChar(u, d) ? "w" : c && "\n" == u ? "n" : !c || /\s/.test(u) ? null : "p";
                        if (!c || p || h || (h = "s"), s && s != h) {
                            n < 0 && (n = 1, moveOnce(), t.sticky = "after");
                            break
                        }
                        if (h && (s = h), n > 0 && !moveOnce(!p)) break
                    }
            ...
            function findPosV(e, t, n, r) {
                ...
                if ("page" == r) {
                    var s = Math.min(e.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight),
                        c = Math.max(s - .5 * textHeight(e.display), 3);
                    o = (n > 0 ? t.bottom : t.top) + n * c
                } else "line" == r && (o = n > 0 ? t.bottom + 3 : t.top - 3);
                for (;
                    (i = coordsChar(e, l, o)).outside;) {
            ...
            function domTextBetween(e, t, n, r, o) {
                ...
                function walk(t) {
                    if (1 == t.nodeType) {
                        ...
                        var i, c = t.getAttribute("cm-marker");
                        if (c) {
                            var d = e.findMarks(Pos(r, 0), Pos(o + 1, 0), (h = +c, function(e) {
                                return e.id == h
                            }));
                            return void(d.length && (i = d[0].find(0)) && addText(getBetween(e.doc, i.from, i.to).join(l)))
                        }
                        if ("false" == t.getAttribute("contenteditable")) return;
                        var p = /^(pre|div|p|li|table|br)$/i.test(t.nodeName);
                        if (!/^br$/i.test(t.nodeName) && 0 == t.textContent.length) return;
                        p && close();
                        for (var u = 0; u < t.childNodes.length; u++) walk(t.childNodes[u]);
                        /^(pre|p)$/i.test(t.nodeName) && (s = !0), p && (a = !0)
                    } else 3 == t.nodeType && addText(t.nodeValue.replace(/\u200b/g, "").replace(/\u00a0/g, " "));
                    var h
                }
                for (; walk(t), t != n;) t = t.nextSibling, s = !1;
                return i
            }
            ...
            function locateNodeInLineView(e, t, n) {
                ...
                function find(t, n, r) {
                    for (var o = -1; o < (c ? c.length : 0); o++)
                        for (var i = o < 0 ? s.map : c[o], a = 0; a < i.length; a += 3) {
                            var l = i[a + 2];
                            if (l == t || l == n) {
                                var d = lineNo(o < 0 ? e.line : e.rest[o]),
                                    p = i[a] + r;
                                return (r < 0 || l != t) && (p = i[a + (r ? 1 : 0)]), Pos(d, p)
                            }
                        }
                }
                var d = find(a, l, n);
                if (d) return badPos(d, o);
                for (var p = l.nextSibling, u = a ? a.nodeValue.length - n : 0; p; p = p.nextSibling) {
                    if (d = find(p, p.firstChild, 0)) return badPos(Pos(d.line, d.ch - u), o);
                    u += p.textContent.length
                }
                for (var h = l.previousSibling, f = n; h; h = h.previousSibling) {
                    if (d = find(h, h.firstChild, -1)) return badPos(Pos(d.line, d.ch + f), o);
            ...
            Ue.prototype.init = function(e) {
                ...
                function onCopyCut(e) {
                    if (!signalDOMEvent(r, e)) {
                        if (r.somethingSelected()) setLastCopied({
                            lineWise: !1,
                            ...
                            setLastCopied({
                                ...
                                r.setSelections(t.ranges, 0, N), r.replaceSelection("", null, "cut")
                            })
                        }
                        if (e.clipboardData) {
                        ...
                        var a = hiddenTextarea(),
                            l = a.firstChild;
                        r.display.lineSpace.insertBefore(a, r.display.lineSpace.firstChild), l.value = Ve.text.join("\n");
                        var s = document.activeElement;
                        M(l), setTimeout(function() {
                            r.display.lineSpace.removeChild(a), s.focus(), s == o && n.showPrimarySelection()
                        }, 50)
                    }
                }
                disableBrowserMagic(o, r.options.spellcheck), j(o, "paste", function(e) {
                    signalDOMEvent(r, e) || handlePaste(e, r) || l <= 11 && setTimeout(operation(r, function() {
                ...
                var e = this.getSelection(),
                    ...
                    o = r.from(),
                    i = r.to();
                if (t.display.viewTo == t.display.viewFrom || o.line >= t.display.viewTo || i.line < t.display.viewFrom) e.removeAllRanges();
                else {
                    var a = domToPos(t, e.anchorNode, e.anchorOffset),
                        l = domToPos(t, e.focusNode, e.focusOffset);
                    if (!a || a.bad || !l || l.bad || 0 != cmp(minPos(a, l), o) || 0 != cmp(maxPos(a, l), i)) {
                        var s = t.display.view,
                            c = o.line >= t.display.viewFrom && posToDOM(t, o) || {
                                node: s[0].measure.map[2],
                                offset: 0
                            },
                            d = i.line < t.display.viewTo && posToDOM(t, i);
                        if (!d) {
                        ...
                        if (c && d) {
                            ...
                            try {
                                h = S(c.node, c.offset, d.offset, d.node)
                            } catch (e) {}
                            h && (!n && t.state.focused ? (e.collapse(c.node, c.offset), h.collapsed || (e.removeAllRanges(), e.addRange(h))) : (e.removeAllRanges(), e.addRange(h)), f && null == e.anchorNode ? e.addRange(f) : n && this.startGracePeriod()), this.rememberSelection()
                ...
                if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
                    var e = this.getSelection(),
                        t = this.cm;
                    if (g && d && this.cm.options.gutters.length && isInGutter(e.anchorNode)) return this.cm.triggerOnKeyDown({
                        type: "keydown",
                        keyCode: 8,
                    ...
                    if (!this.composing) {
                        ...
                        n && r && runInOp(t, function() {
                            setSelection(t.doc, simpleSelection(n, r), N), (n.bad || r.bad) && (t.curOp.selectionChanged = !0)
                        })
                    }
                }
                ...
                var e, t, n, r = this.cm,
                    ...
                    a = i.from(),
                    l = i.to();
                if (0 == a.ch && a.line > r.firstLine() && (a = Pos(a.line - 1, getLine(r.doc, a.line - 1).length)), l.ch == getLine(r.doc, l.line).text.length && l.line < r.lastLine() && (l = Pos(l.line + 1, 0)), a.line < o.viewFrom || l.line > o.viewTo - 1) return !1;
                a.line == o.viewFrom || 0 == (e = findViewIndex(r, a.line)) ? (t = lineNo(o.view[0].line), n = o.view[0].node) : (t = lineNo(o.view[e].line), n = o.view[e - 1].node.nextSibling);
                var s, c, d = findViewIndex(r, l.line);
                if (d == o.view.length - 1 ? (s = o.viewTo - 1, c = o.lineDiv.lastChild) : (s = lineNo(o.view[d + 1].line) - 1, c = o.view[d + 1].node.previousSibling), !n) return !1;
                for (var p = r.doc.splitLines(domTextBetween(r, n, c, t, s)), u = getBetween(r.doc, Pos(t, 0), Pos(s, getLine(r.doc, s).text.length)); p.length > 1 && u.length > 1;)
                    if (lst(p) == lst(u)) p.pop(), u.pop(), s--;
                    else {
                        if (p[0] != u[0]) break;
                        p.shift(), u.shift(), t++
                    }
                for (var h = 0, f = 0, m = p[0], g = u[0], v = Math.min(m.length, g.length); h < v && m.charCodeAt(h) == g.charCodeAt(h);) ++h;
                for (var b = lst(p), y = lst(u), x = Math.min(b.length - (1 == p.length ? h : 0), y.length - (1 == u.length ? h : 0)); f < x && b.charCodeAt(b.length - f - 1) == y.charCodeAt(y.length - f - 1);) ++f;
                if (1 == p.length && 1 == u.length && t == a.line)
                    for (; h && h > a.ch && b.charCodeAt(b.length - f - 1) == y.charCodeAt(y.length - f - 1);) h--, f++;
                p[p.length - 1] = b.slice(0, b.length - f).replace(/^\u200b+/, ""), p[0] = p[0].slice(h).replace(/\u200b+$/, "");
                var w = Pos(t, h),
                    C = Pos(s, u.length ? lst(u).length - f : 0);
                return p.length > 1 || p[0] || cmp(w, C) ? (replaceRange(r.doc, p, w, C, "+input"), !0) : void 0
            ...
            }, Ue.prototype.onContextMenu = function() {}, Ue.prototype.resetPosition = function() {}, Ue.prototype.needsContentAttribute = !0;
            var _e = function(e) {
                this.cm = e, this.prevInput = "", this.pollingFast = !1, this.polling = new T, this.hasSelection = !1, this.composing = null
            };
            _e.prototype.init = function(e) {
                        ...
                        if (!signalDOMEvent(r, e)) {
                            if (r.somethingSelected()) setLastCopied({
                                ...
                                setLastCopied({
                                    lineWise: !0,
                                    text: t.text
                                }), "cut" == e.type ? r.setSelections(t.ranges, null, N) : (n.prevInput = "", o.value = t.text.join("\n"), M(o))
                            }
                            "cut" == e.type && (r.state.cutIncoming = !0)
                        }
                    }
                    e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild), m && (o.style.width = "0px"), j(o, "input", function() {
                    ...
                    }), j(o, "cut", prepareCopyCut), j(o, "copy", prepareCopyCut), j(e.scroller, "paste", function(t) {
                    ...
                    removeChildrenAndAdd(t.cursorDiv, e.cursors), removeChildrenAndAdd(t.selectionDiv, e.selection), null != e.teTop && (this.wrapper.style.top = e.teTop + "px", this.wrapper.style.left = e.teLeft + "px")
                    ...
                    if (!this.contextMenuPending && !this.composing) {
                        ...
                        if (t.somethingSelected()) {
                            ...
                            this.textarea.value = n, t.state.focused && M(this.textarea), a && l >= 9 && (this.hasSelection = n)
                    ...
                    if ("nocursor" != this.cm.options.readOnly && (!v || activeElt() != this.textarea)) try {
                        this.textarea.focus()
                    } catch (e) {}
                    ...
                    var e = !1,
                        t = this;
                    t.pollingFast = !0, t.polling.set(20, function p() {
                    ...
                    var e = this,
                        ...
                        n = this.textarea,
                        r = this.prevInput;
                    if (this.contextMenuPending || !t.state.focused || q(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq) return !1;
                    var o = n.value;
                    if (o == r && !t.somethingSelected()) return !1;
                    if (a && l >= 9 && this.hasSelection === o || b && /[\uf700-\uf7ff]/.test(o)) return t.display.input.reset(), !1;
                    if (t.doc.sel == t.display.selForContextMenu) {
                        var i = o.charCodeAt(0);
                        if (8203 != i || r || (r = "​"), 8666 == i) return this.reset(), this.cm.execCommand("undo")
                    }
                    for (var s = 0, c = Math.min(r.length, o.length); s < c && r.charCodeAt(s) == o.charCodeAt(s);) ++s;
                    return runInOp(t, function() {
                        applyTextInput(t, o.slice(s), r.length - s, null, e.composing ? "*compose" : null), o.length > 1e3 || o.indexOf("\n") > -1 ? n.value = e.prevInput = "" : e.prevInput = o, e.composing && (e.composing.range.clear(), e.composing.range = t.markText(e.composing.start, t.getCursor("to"), {
                            className: "CodeMirror-composing"
                        }))
                    }), !0
                    ...
                    if (i && !p) {
                        n.options.resetSelectionOnContextMenu && -1 == n.doc.sel.contains(i) && operation(n, setSelection)(n.doc, simpleSelection(i), N);
                        var d = o.style.cssText,
                            u = t.wrapper.style.cssText;
                        t.wrapper.style.cssText = "position: absolute";
                        var h, f = t.wrapper.getBoundingClientRect();
                        if (o.style.cssText = "position: absolute; width: 30px; height: 30px;\n      top: " + (e.clientY - f.top - 5) + "px; left: " + (e.clientX - f.left - 5) + "px;\n      z-index: 1000; background: " + (a ? "rgba(255, 255, 255, .05)" : "transparent") + ";\n      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", s && (h = window.scrollY), r.input.focus(), s && window.scrollTo(null, h), r.input.reset(), n.somethingSelected() || (o.value = t.prevInput = " "), t.contextMenuPending = !0, r.selForContextMenu = n.doc.sel, clearTimeout(r.detectingSelectAll), a && l >= 9 && prepareSelectAllHack(), k) {
                            e_stop(e);
                            var m = function() {
                    ...
                    function prepareSelectAllHack() {
                        if (null != o.selectionStart) {
                            var e = n.somethingSelected(),
                                i = "​" + (e ? o.value : "");
                            o.value = "⇚", o.value = i, t.prevInput = e ? "" : "​", o.selectionStart = 1, o.selectionEnd = i.length, r.selForContextMenu = n.doc.sel
                        }
                    }

                    function rehide() {
                        if (t.contextMenuPending = !1, t.wrapper.style.cssText = u, o.style.cssText = d, a && l < 9 && r.scrollbars.setScrollTop(r.scroller.scrollTop = c), null != o.selectionStart) {
                            (!a || a && l < 9) && prepareSelectAllHack();
                            var e = 0,
                                i = function() {
                                    r.selForContextMenu == n.doc.sel && 0 == o.selectionStart && o.selectionEnd > 0 && "​" == t.prevInput ? operation(n, selectAll)(n) : e++ < 10 ? r.detectingSelectAll = setTimeout(i, 500) : (r.selForContextMenu = null, r.input.reset())
                                };
                ...
                function defineOptions(e) {
                    ...
                    function option(n, r, o, i) {
                        e.defaults[n] = r, o && (t[n] = i ? function(e, t, n) {
                            n != Fe && o(e, t, n)
                        } : o)
                    }
                    e.defineOption = option, e.Init = Fe, option("value", "", function(e, t) {
                        return e.setValue(t)
                        ...
                        if (e.doc.lineSep = t, t) {
                            ...
                            for (var o = n.length - 1; o >= 0; o--) replaceRange(e.doc, t, n[o], Pos(n[o].line, n[o].ch + t.length))
                        }
                    }), option("specialChars", /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b-\u200f\u2028\u2029\ufeff]/g, function(e, t, n) {
                        e.state.specialChars = new RegExp(t.source + (t.test("\t") ? "" : "|\t"), "g"), n != Fe && e.refresh()
                    }), option("specialCharPlaceholder", defaultSpecialCharPlaceholder, function(e) {
                        return e.refresh()
                    }, !0), option("electricChars", !0), option("inputStyle", v ? "contenteditable" : "textarea", function() {
                        throw new Error("inputStyle can not (yet) be changed in a running editor")
                    }, !0), option("spellcheck", !1, function(e, t) {
                        return e.getInputField().spellcheck = t
                    }, !0), option("rtlMoveVisually", !x), option("wholeLineUpdateBefore", !0), option("theme", "default", function(e) {
                        ...
                        return e
                    }, guttersChanged, !0), option("showCursorWhenSelecting", !1, updateSelection, !0), option("resetSelectionOnContextMenu", !0), option("lineWiseCopyCut", !0), option("pasteLinesPerSelection", !0), option("readOnly", !1, function(e, t) {
                ...
                function(e) {
                    ...
                    e.prototype = {
                        ...
                        setOption: function(e, n) {
                            var r = this.options,
                                o = r[e];
                            r[e] == n && "mode" != e || (r[e] = n, t.hasOwnProperty(e) && operation(this, t[e])(this, n, o), signal(this, "optionChange", this, e))
                        },
                        ...
                        removeOverlay: methodOp(function(e) {
                            for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
                                var r = t[n].modeSpec;
                                if (r == e || "string" == typeof e && r.name == e) return t.splice(n, 1), this.state.modeGen++, void regChange(this)
                            }
                        }),
                        ...
                        indentSelection: methodOp(function(e) {
                            for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                                var o = t[r];
                                if (o.empty()) o.head.line > n && (indentLine(this, o.head.line, e, !0), n = o.head.line, r == this.doc.sel.primIndex && ensureCursorVisible(this));
                                else {
                                    var i = o.from(),
                                        a = o.to(),
                                        l = Math.max(n, i.line);
                                    n = Math.min(this.lastLine(), a.line - (a.ch ? 0 : 1)) + 1;
                                    for (var s = l; s < n; ++s) indentLine(this, s, e);
                                    var c = this.doc.sel.ranges;
                                    0 == i.ch && t.length == c.length && c[r].from().ch > 0 && replaceOneSelection(this.doc, r, new be(i, c[r].to()), N)
                                }
                            }
                        }),
                        ...
                        getTokenTypeAt: function(e) {
                            ...
                            var t, n = getLineStyles(this, getLine(this.doc, e.line)),
                                r = 0,
                                o = (n.length - 1) / 2,
                                i = e.ch;
                            if (0 == i) t = n[2];
                        ...
                        getHelpers: function(e, t) {
                            ...
                            if ("string" == typeof i[t]) o[i[t]] && r.push(o[i[t]]);
                                ...
                                for (var a = 0; a < i[t].length; a++) {
                                    var l = o[i[t][a]];
                                    l && r.push(l)
                                } else i.helperType && o[i.helperType] ? r.push(o[i.helperType]) : o[i.name] && r.push(o[i.name]);
                        ...
                        heightAtLine: function(e, t, n) {
                            ...
                            if ("number" == typeof e) {
                                ...
                                e < this.doc.first ? e = this.doc.first : e > i && (e = i, o = !0), r = getLine(this.doc, e)
                            } else r = e;
                            return intoCoordSystem(this, r, {
                                top: 0,
                                left: 0
                            }, t || "page", n || o).top + (o ? this.doc.height - heightAtLine(r) : 0)
                        },
                        ...
                        addWidget: function(e, t, n, r, o) {
                            ...
                            if (t.style.position = "absolute", t.setAttribute("cm-ignore-events", "true"), this.display.input.setUneditable(t), s.sizer.appendChild(t), "over" == r) c = e.top;
                                ...
                                var p = Math.max(s.wrapper.clientHeight, this.doc.height),
                                    u = Math.max(s.sizer.clientWidth, s.lineSpace.clientWidth);
                                ("above" == r || e.bottom + t.offsetHeight > p) && e.top > t.offsetHeight ? c = e.top - t.offsetHeight : e.bottom + t.offsetHeight <= p && (c = e.bottom), d + t.offsetWidth > u && (d = u - t.offsetWidth)
                            }
                            t.style.top = c + "px", t.style.left = t.style.right = "", "right" == o ? (d = s.sizer.clientWidth - t.offsetWidth, t.style.right = "0px") : ("left" == o ? d = 0 : "middle" == o && (d = (s.sizer.clientWidth - t.offsetWidth) / 2), t.style.left = d + "px"), n && (i = this, a = {
                                left: d,
                                top: c,
                                right: d + t.offsetWidth,
                                bottom: c + t.offsetHeight
                            }, null != (l = calculateScrollPos(i, a)).scrollTop && updateScrollTop(i, l.scrollTop), null != l.scrollLeft && setScrollLeft(i, l.scrollLeft))
                        },
                        ...
                        findPosH: function(e, t, n, r) {
                            var o = 1;
                            t < 0 && (o = -1, t = -t);
                            for (var i = clipPos(this.doc, e), a = 0; a < t && !(i = findPosH(this.doc, i, o, n, r)).hitSide; ++a);
                            return i
                        },
                        moveH: methodOp(function(e, t) {
                            var n = this;
                            this.extendSelectionsBy(function(r) {
                                return n.display.shift || n.doc.extend || r.empty() ? findPosH(n.doc, r.head, e, t, n.options.rtlMoveVisually) : e < 0 ? r.from() : r.to()
                            }, D)
                        }),
                        deleteH: methodOp(function(e, t) {
                            var n = this.doc.sel,
                                r = this.doc;
                            n.somethingSelected() ? r.replaceSelection("", null, "+delete") : deleteNearSelection(this, function(n) {
                        ...
                        findPosV: function(e, t, n, r) {
                            var o = 1,
                                i = r;
                            t < 0 && (o = -1, t = -t);
                            for (var a = clipPos(this.doc, e), l = 0; l < t; ++l) {
                                var s = cursorCoords(this, a, "div");
                                if (null == i ? i = s.left : s.left = i, (a = findPosV(this, s, o, n)).hitSide) break
                            }
                            return a
                        },
                        moveV: methodOp(function(e, t) {
                            ...
                            if (r.extendSelectionsBy(function(a) {
                                    ...
                                    null != a.goalColumn && (l.left = a.goalColumn), o.push(l.left);
                                    var s = findPosV(n, l, e, t);
                                    return "page" == t && a == r.sel.primary() && addToScrollTop(n, charCoords(n, s, "div").top - l.top), s
                                }, D), o.length)
                        ...
                        findWordAt: function(e) {
                            ...
                            if (t) {
                                ...
                                for (var i = t.charAt(n), a = isWordChar(i, o) ? function(e) {
                            ...
                            return new be(Pos(e.line, n), Pos(e.line, r))
                        },
                        toggleOverwrite: function(e) {
                        ...
                        setSize: methodOp(function(e, t) {
                            ...
                            null != e && (this.display.wrapper.style.width = r(e)), null != t && (this.display.wrapper.style.height = r(t)), this.options.lineWrapping && clearLineMeasurementCache(this);
                        ...
                        refresh: methodOp(function() {
                            ...
                            regChange(this), this.curOp.forceUpdate = !0, clearCaches(this), scrollToCoords(this, this.doc.scrollLeft, this.doc.scrollTop), updateGutterSpace(this), (null == e || Math.abs(e - textHeight(this.display)) > .5) && estimateLineHeights(this), signal(this, "refresh", this)
                        }),
                    ...
                    }, eventMixin(e), e.registerHelper = function(t, r, o) {
            ...
            for (var Ke in Se.prototype) Se.prototype.hasOwnProperty(Ke) && indexOf(Ge, Ke) < 0 && (CodeMirror$1.prototype[Ke] = function(e) {
                return function() {
                    return e.apply(this.doc, arguments)
                }
            }(Se.prototype[Ke]));
            return eventMixin(Se), CodeMirror$1.inputStyles = {
                    textarea: _e,
                    contenteditable: Ue
                }, CodeMirror$1.defineMode = function(e) {
                    CodeMirror$1.defaults.mode || "null" == e || (CodeMirror$1.defaults.mode = e), defineMode.apply(this, arguments)
                ...
                }), CodeMirror$1.defineMIME("text/plain", "null"), CodeMirror$1.defineExtension = function(e, t) {
                    ...
                    if ((t = t ? copyObj(t) : {}).value = e.value, !t.tabindex && e.tabIndex && (t.tabindex = e.tabIndex), !t.placeholder && e.placeholder && (t.placeholder = e.placeholder), null == t.autofocus) {
                        var n = activeElt();
                    ...
                    var r;
                    if (e.form && (j(e.form, "submit", save), !t.leaveSubmitMethodAlone)) {
                        var o = e.form;
                        r = o.submit;
                        try {
                    ...
                    t.finishInit = function(t) {
                        t.save = save, t.getTextArea = function() {
                            ...
                            t.toTextArea = isNaN, save(), e.parentNode.removeChild(t.getWrapperElement()), e.style.display = "", e.form && (off(e.form, "submit", save), "function" == typeof e.form.submit && (e.form.submit = r))
                        }
                ...
                function addLegacyProps(e) {
                    e.off = off, e.on = j, e.wheelEventPixels = wheelEventPixels, e.Doc = Se, e.splitLines = K, e.countColumn = countColumn, e.findColumn = findColumn, e.isWordChar = isWordCharBasic, e.Pass = P, e.signal = signal, e.Line = re, e.changeEnd = changeEnd, e.scrollbarModel = ue, e.Pos = Pos, e.cmpPos = cmp, e.modes = Y, e.mimeModes = Z, e.resolveMode = resolveMode, e.getMode = getMode, e.modeExtensions = J, e.extendMode = extendMode, e.copyState = copyState, e.startState = startState, e.innerMode = innerMode, e.commands = De, e.keyMap = Ae, e.keyName = keyName, e.isModifierKey = isModifierKey, e.lookupKey = lookupKey, e.normalizeKeyMap = normalizeKeyMap, e.StringStream = Q, e.SharedTextMarker = Ce, e.TextMarker = we, e.LineWidget = ye, e.e_preventDefault = e_preventDefault, e.e_stopPropagation = e_stopPropagation, e.e_stop = e_stop, e.addClass = addClass, e.contains = contains, e.rmClass = L, e.keyNames = Te
                }(CodeMirror$1), CodeMirror$1.version = "5.39.0", CodeMirror$1
        }, e.exports = r()
    },
    "9B+i": function(e, t, n) {
    ...
    KR8v: function(e, t, n) {
        (function(e) {
            ...
            e.defineMode("jsx", function(t, n) {
                ...
                function token(e, t) {
                    return t.context.mode == r ? xmlToken(e, t, t.context) : jsToken(e, t, t.context)
                }
                ...
                function xmlToken(n, i, a) {
                    ...
                    if ("{" == n.peek()) {
                        ...
                        if (s && n.match(/^[^>]*>\s*$/, !1)) {
                            ...
                            s.startOfLine ? l -= t.indentUnit : a.prev.state.lexical && (l = a.prev.state.lexical.indented)
                        } else 1 == a.depth && (l += t.indentUnit);
                        return i.context = new Context(e.startState(o, l), o, 0, i.context), null
                    }
                    if (1 == a.depth) {
                        if ("<" == n.peek()) return r.skipAttribute(a.state), i.context = new Context(e.startState(r, flatXMLIndent(a.state)), r, 0, i.context), null;
                        if (n.match("//")) return n.skipToEnd(), "comment";
                        if (n.match("/*")) return a.depth = 2, token(n, i)
                    }
                    var c, d = r.token(n, a.state),
                        p = n.current();
                    return /\btag\b/.test(d) ? />$/.test(p) ? a.state.context ? a.depth = 0 : i.context = i.context.prev : /^</.test(p) && (a.depth = 1) : !d && (c = p.indexOf("{")) > -1 && n.backUp(p.length - c), d
                }

                function jsToken(t, n, i) {
                    if ("<" == t.peek() && o.expressionAllowed(t, i.state)) return o.skipExpression(i.state), n.context = new Context(e.startState(r, o.indent(i.state, "")), r, 0, n.context), null;
                    var a = o.token(t, i.state);
                    if (!a && null != i.depth) {
                        var l = t.current();
                        "{" == l ? i.depth++ : "}" == l && 0 == --i.depth && (n.context = n.context.prev)
                    }
                    return a
                }
                return {
                    startState: function() {
                        return {
                            context: new Context(e.startState(o), o)
                        }
                    },
        ...
        })(n("8U58"), n("ezqs"), n("5IAE"))
    },
    "M/gZ": function(e, t, n) {
        "use strict";
        var r = n("GiK3");
        n.n(r);
        const o = n("lpIW").default,
            i = n("6x/j").default,
            a = n("Onti").default,
            l = n("7YgM"),
            s = n("eHuQ"),
        ...
        t.a = a(({
            ...
            return r.createElement("div", {
                ...
                className: e.bar
            }, r.createElement(o, null, t), r.createElement("nav", {
                className: e.nav
            }, r.createElement("a", {
            ...
            }, "GitHub"), r.createElement("a", {
                className: e.headerLink,
                href: "https://gitter.im/styleguidist/styleguidist"
            }, "Gitter"))))), r.createElement("main", {
                className: e.content
            ...
            }, r.createElement("h1", null, "Jenkins Design Language"), r.createElement("h3", null, "React library for Jenkins Blue Ocean"), r.createElement("iframe", {
            ...
            })))), u && r.createElement("footer", {
                className: e.footer
            }, r.createElement(i, {
                text: `Generated with [React Styleguidist](${n}) ❤️`
            }))), d && r.createElement("div", {
                className: e.sidebar
            }, r.createElement("div", {
                className: e.logo
            }, r.createElement(o, null, t, " ", r.createElement("div", {
                className: e.version
            }, "v ", l.version))), c), r.createElement("a", {
    ...
    P8uf: function(e, t, n) {
        var r = {
            ...
            o = n("kCi/").bind(null, r),
            i = n("grFk").bind(null, "var React = require('react');", o);
        e.exports = [{
            type: "markdown",
    ...
    SkAB: function(e, t, n) {
        ...
        (function(e) {
            ...
            var d = function() {
                    function Helper() {}
                    return Helper.equals = function(e, t) {
                        var n = this,
                            r = Object.keys,
                            o = void 0 === e ? "undefined" : i(e),
                            a = void 0 === t ? "undefined" : i(t);
                        return e && t && "object" === o && o === a ? r(e).length === r(t).length && r(e).every(function(r) {
                ...
                p = function() {
                    ...
                    return Shared.prototype.delegateCursor = function(e, t, n) {
                        ...
                        e && e.selection && e.selection.ranges && this.delegateSelection(e.selection.ranges, e.selection.focus || !1), e && e.cursor && this.delegateCursor(e.cursor, e.autoScroll || !1, e.autoFocus || !1), e && e.scroll && this.delegateScroll(e.scroll)
                    }, Shared.prototype.applyNext = function(e, t, n) {
                        e && e.selection && e.selection.ranges && t && t.selection && t.selection.ranges && !d.equals(e.selection.ranges, t.selection.ranges) && this.delegateSelection(t.selection.ranges, t.selection.focus || !1), e && e.cursor && t && t.cursor && !d.equals(e.cursor, t.cursor) && this.delegateCursor(n.cursor || t.cursor, t.autoScroll || !1, t.autoCursor || !1), e && e.scroll && t && t.scroll && !d.equals(e.scroll, t.scroll) && this.delegateScroll(t.scroll)
                ...
                u = function(e) {
                    function Controlled(t) {
                        ...
                        return c ? n : (n.applied = !1, n.appliedNext = !1, n.appliedUserDefined = !1, n.deferred = null, n.emulating = !1, n.hydrated = !1, n.initCb = function() {
                            n.props.editorDidConfigure && n.props.editorDidConfigure(n.editor)
                        }, n.mounted = !1, n)
                    }
                    return a(Controlled, e), Controlled.prototype.hydrate = function(e) {
                        var t = this,
                            n = o({}, l.defaults, this.editor.options, e.options || {});
                        Object.keys(n).some(function(e) {
                            return t.editor.getOption(e) !== n[e]
                        }) && Object.keys(n).forEach(function(r) {
                            e.options.hasOwnProperty(r) && t.editor.getOption(r) !== n[r] && (t.editor.setOption(r, n[r]), t.mirror.setOption(r, n[r]))
                        }), this.hydrated || (this.mounted && this.deferred ? this.resolveChange() : this.initChange(e.value || "")), this.hydrated = !0
                        ...
                        this.editor.replaceRange(e || "", {
                            ...
                            line: t,
                            ch: n
                        }), this.mirror.setValue(e), this.editor.clearHistory(), this.mirror.clearHistory(), this.emulating = !1
                    }, Controlled.prototype.resolveChange = function() {
                        this.emulating = !0, "undo" === this.deferred.origin ? this.editor.undo() : "redo" === this.deferred.origin ? this.editor.redo() : this.editor.replaceRange(this.deferred.text, this.deferred.from, this.deferred.to, this.deferred.origin), this.emulating = !1, this.deferred = null
                    }, Controlled.prototype.mirrorChange = function(e) {
                        return "undo" === e.origin ? (this.editor.setHistory(this.mirror.getHistory()), this.mirror.undo()) : "redo" === e.origin ? (this.editor.setHistory(this.mirror.getHistory()), this.mirror.redo()) : this.mirror.replaceRange(e.text, e.from, e.to, e.origin), this.mirror.getValue()
                        ...
                        var e = this;
                        c || (this.props.defineMode && this.props.defineMode.name && this.props.defineMode.fn && l.defineMode(this.props.defineMode.name, this.props.defineMode.fn), this.editor = l(this.ref), this.shared = new p(this.editor, this.props), this.mirror = l(function() {}), this.editor.on("electricInput", function() {
                        ...
                        }), this.hydrate(this.props), this.shared.apply(this.props), this.applied = !0, this.mounted = !0, this.shared.wire(this.props), this.props.editorDidMount && this.props.editorDidMount(this.editor, this.editor.getValue(), this.initCb))
                    }, Controlled.prototype.componentWillReceiveProps = function(e) {
                        if (!c) {
                            var t = {
                                cursor: null
                            };
                            e.value !== this.props.value && (this.hydrated = !1), this.props.autoCursor || void 0 === this.props.autoCursor || (t.cursor = this.editor.getCursor()), this.hydrate(e), this.appliedNext || (this.shared.applyNext(this.props, e, t), this.appliedNext = !0), this.shared.applyUserDefined(this.props, t), this.appliedUserDefined = !0
                        }
            ...
            var h = function(e) {
                function UnControlled(t) {
                    var n = e.call(this, t) || this;
                    return c ? n : (n.applied = !1, n.appliedUserDefined = !1, n.continueChange = !1, n.detached = !1, n.hydrated = !1, n.initCb = function() {
                        n.props.editorDidConfigure && n.props.editorDidConfigure(n.editor)
                    }, n.mounted = !1, n.onBeforeChangeCb = function() {
                        n.continueChange = !0
                    }, n)
                }
                return a(UnControlled, e), UnControlled.prototype.hydrate = function(e) {
                    var t = this,
                        n = o({}, l.defaults, this.editor.options, e.options || {});
                    ...
                    var e = this;
                    c || (this.detached = !0 === this.props.detach, this.props.defineMode && this.props.defineMode.name && this.props.defineMode.fn && l.defineMode(this.props.defineMode.name, this.props.defineMode.fn), this.editor = l(this.ref), this.shared = new p(this.editor, this.props), this.editor.on("beforeChange", function(t, n) {
                    ...
                    }), this.hydrate(this.props), this.shared.apply(this.props), this.applied = !0, this.mounted = !0, this.shared.wire(this.props), this.editor.clearHistory(), this.props.editorDidMount && this.props.editorDidMount(this.editor, this.editor.getValue(), this.initCb))
                    ...
                    if (this.detached && !1 === e.detach && (this.detached = !1, this.props.editorDidAttach && this.props.editorDidAttach(this.editor)), this.detached || !0 !== e.detach || (this.detached = !0, this.props.editorDidDetach && this.props.editorDidDetach(this.editor)), !c && !this.detached) {
                        ...
                        e.value !== this.props.value && (this.hydrated = !1, this.applied = !1, this.appliedUserDefined = !1), this.props.autoCursor || void 0 === this.props.autoCursor || (t.cursor = this.editor.getCursor()), this.hydrate(e), this.applied || (this.shared.apply(this.props), this.applied = !0), this.appliedUserDefined || (this.shared.applyUserDefined(this.props, t), this.appliedUserDefined = !0)
                    }
    ...
    eAAd: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.css = function css(e, ...t) {
            let n = 0 == t.length ? "" : 1 === t.length ? t[0] : t.join(" ");
    ...
    eeK1: function(e, t, n) {
        ...
        class o extends r.Component {
            render() {
                let e = !1;
                const t = r.createElement("thead", null, r.createElement("tr", null, this.props.children.map((t, n) => (t.props.header && (e = !0), r.createElement("th", {
                    key: n
                }, t.props.header)))));
                let n = !1;
                const o = r.createElement("tfoot", null, r.createElement("tr", null, this.props.children.map((e, t) => (e.props.footer && (n = !0), r.createElement("td", {
                    key: t
                }, e.props.footer)))));
                return r.createElement("table", {
                    className: "Table"
                }, e && t, r.createElement("tbody", {
                    key: this.props.items.length
                }, this.props.items.map((e, t) => r.createElement("tr", {
                    key: t
                }, this.props.children.map((t, n) => r.createElement("td", {
                    key: n,
                    className: t.props.expand ? "expand" : void 0
                }, t.props.cell(e)))))), n && o)
            }
        }
        t.DataTable = o, o.Column = class extends r.Component {
            render() {
                return null
            }
        }
    ...
    eiqd: function(e, t, n) {
        var r = {
            ...
            o = n("kCi/").bind(null, r);
        n("grFk").bind(null, "var React = require('react');", o);
        e.exports = [{
            type: "markdown",
        ...
        (function(e) {
            ...
            e.defineMode("xml", function(r, o) {
                ...
                function inText(e, t) {
                    ...
                    var n = e.next();
                    return "<" == n ? e.eat("!") ? e.eat("[") ? e.match("CDATA[") ? chain(inBlock("atom", "]]>")) : null : e.match("--") ? chain(inBlock("comment", "--\x3e")) : e.match("DOCTYPE", !0, !0) ? (e.eatWhile(/[\w\._\-]/), chain(doctype(1))) : null : e.eat("?") ? (e.eatWhile(/[\w\._\-]/), t.tokenize = inBlock("meta", "?>"), "meta") : (i = e.eat("/") ? "closeTag" : "openTag", t.tokenize = inTag, "tag bracket") : "&" == n ? (e.eat("#") ? e.eat("x") ? e.eatWhile(/[a-fA-F\d]/) && e.eat(";") : e.eatWhile(/[\d]/) && e.eat(";") : e.eatWhile(/[\w\.\-:]/) && e.eat(";")) ? "atom" : "error" : (e.eatWhile(/[^&<]/), null)
                }

                function inTag(e, t) {
                    var n = e.next();
                    if (">" == n || "/" == n && e.eat(">")) return t.tokenize = inText, i = ">" == n ? "endTag" : "selfcloseTag", "tag bracket";
                    ...
                    return /[\'\"]/.test(n) ? (t.tokenize = inAttribute(n), t.stringStartCol = e.column(), t.tokenize(e, t)) : (e.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), "word")
                }
                ...
                function baseState(e, t, n) {
                    return "openTag" == e ? (n.tagStart = t.column(), tagNameState) : "closeTag" == e ? closeTagNameState : baseState
                }

                function tagNameState(e, t, n) {
                    return "word" == e ? (n.tagName = t.current(), a = "tag", attrState) : s.allowMissingTagName && "endTag" == e ? (a = "tag bracket", attrState(e, t, n)) : (a = "error", tagNameState)
                }

                function closeTagNameState(e, t, n) {
                    if ("word" == e) {
                        var r = t.current();
                        return n.context && n.context.tagName != r && s.implicitlyClosed.hasOwnProperty(n.context.tagName) && popContext(n), n.context && n.context.tagName == r || !1 === s.matchClosing ? (a = "tag", closeState) : (a = "tag error", closeStateErr)
                    }
                    return s.allowMissingTagName && "endTag" == e ? (a = "tag bracket", closeState(e, t, n)) : (a = "error", closeStateErr)
                }
                ...
                function attrState(e, t, n) {
                    ...
                    if ("endTag" == e || "selfcloseTag" == e) {
                        var r = n.tagName,
                            o = n.tagStart;
                        return n.tagName = n.tagStart = null, "selfcloseTag" == e || s.autoSelfClosers.hasOwnProperty(r) ? maybePopContext(n, r) : (maybePopContext(n, r), n.context = new Context(n, r, o == n.indented)), baseState
                    }
                    return a = "error", attrState
                }

                function attrEqState(e, t, n) {
                    return "equals" == e ? attrValueState : (s.allowMissing || (a = "error"), attrState(e, 0, n))
                }

                function attrValueState(e, t, n) {
                    return "string" == e ? attrContinuedState : "word" == e && s.allowUnquoted ? (a = "string", attrState) : (a = "error", attrState(e, 0, n))
                }
                ...
                return inText.isInText = !0, {
                    ...
                    token: function(e, t) {
                        ...
                        i = null;
                        var n = t.tokenize(e, t);
                        return (n || i) && "comment" != n && (a = null, t.state = t.state(i || n, e, t), a && (n = "error" == a ? n + " error" : a)), n
                    },
                    indent: function(t, n, r) {
                        ...
                        if (i && i[1])
                            for (; o;) {
                                ...
                                for (; o;) {
                                    var a = s.contextGrabbers[o.tagName];
                                    if (!a || !a.hasOwnProperty(i[2])) break;
                                    o = o.prev
                                }
                        for (; o && o.prev && !o.startOfLine;) o = o.prev;
                        return o ? o.indent + l : t.baseIndent || 0
                    },
                    electricInput: /<\/[\s\w:]+>$/,
    ...
    ri81: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            return r.createElement("button", {
                className: Object(o.css)(e, "Button"),
                onClick: e => {
                    e.stopPropagation(), e.preventDefault(), n && n(e)
                },
                disabled: i
            }, t)
        };
    ...
    xHFL: function(e, t, n) {
        ...
        t.a = i(({
            ...
            return (t = t.filter(e => e.name)).length ? r.createElement("ul", {
                className: e.list
            }, t.map(({
                heading: t,
                name: n,
                ...
                className: o(e.item, (!a || !a.props.items.length) && e.isChild),
                key: i
            }, t && r.createElement("div", {
                className: o(e.heading)
            }, n), !t && r.createElement("a", {
                className: o(e.itemLink, t && e.heading),
                href: i
            }, n), a))) : null
        })
    }
