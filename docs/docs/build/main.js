webpackJsonp([0], {
    ...
    "3lct": function(n, e, t) {
        ...
        n.exports = [{
            type: "markdown",
            content: 'The data table is a basic table used to display columnar data using a simple declarative syntax.\n\nSimply define as many `Table.Col` children with `title` and `cell` props to get a basic table:\n\n```jsx\n&lt;Table items={users}&gt;\n    <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Table.Col</span> <span class="hljs-attr">title</span>=<span class="hljs-string">"Username"</span> <span class="hljs-attr">expand</span>&gt;</span>{user =&gt; user.username}<span class="hljs-tag">&lt;/<span class="hljs-name">Table.Col</span>&gt;</span>\n    <span class="hljs-tag">&lt;<span class="hljs-name">Table.Col</span> <span class="hljs-attr">title</span>=<span class="hljs-string">"Country"</span>&gt;</span>{user =&gt; user.country}<span class="hljs-tag">&lt;/<span class="hljs-name">Table.Col</span>&gt;</span>\n<span class="hljs-tag">&lt;/<span class="hljs-name">Table</span>&gt;</span></span>\n```'
        }, {
            type: "code",
            content: "const users = [\n    {\n        username: 'Joe',\n        country: 'USA',\n    },\n    {\n        username: 'Vincent',\n        country: 'France',\n    },\n];\n<Table items={users}>\n    <Table.Col title=\"Username\">{user => user.username} expand</Table.Col>\n    <Table.Col title=\"Country\">{user => user.country}</Table.Col>\n</Table>;",
            settings: {},
            evalInContext: o
        }]
    },
